namespace u_net
{
    partial class F_検索
    {
        ...
        private void InitializeComponent()
        {
            ...
            フィルタ_カ.Location = new Point(65, 40);
            フィルタ_カ.Name = "フィルタ_カ";
            フィルタ_カ.Size = new Size(53, 30);
            フィルタ_カ.TabIndex = 0;
            フィルタ_カ.Text = "カ";
            ...
            フィルタ_全て.Location = new Point(615, 40);
            フィルタ_全て.Name = "フィルタ_全て";
            フィルタ_全て.Size = new Size(53, 30);
            フィルタ_全て.TabIndex = 0;
            フィルタ_全て.Text = "全て";
            ...
            フィルタ_abc.Location = new Point(560, 40);
            フィルタ_abc.Name = "フィルタ_abc";
            フィルタ_abc.Size = new Size(53, 30);
            フィルタ_abc.TabIndex = 0;
            フィルタ_abc.Text = "abc";
            ...
            フィルタ_ワ.Location = new Point(505, 40);
            フィルタ_ワ.Name = "フィルタ_ワ";
            フィルタ_ワ.Size = new Size(53, 30);
            フィルタ_ワ.TabIndex = 0;
            フィルタ_ワ.Text = "ワ";
            ...
            フィルタ_ラ.Location = new Point(450, 40);
            フィルタ_ラ.Name = "フィルタ_ラ";
            フィルタ_ラ.Size = new Size(53, 30);
            フィルタ_ラ.TabIndex = 0;
            フィルタ_ラ.Text = "ラ";
            ...
            フィルタ_ヤ.Location = new Point(395, 40);
            フィルタ_ヤ.Name = "フィルタ_ヤ";
            フィルタ_ヤ.Size = new Size(53, 30);
            フィルタ_ヤ.TabIndex = 0;
            フィルタ_ヤ.Text = "ヤ";
            ...
            フィルタ_マ.Location = new Point(340, 40);
            フィルタ_マ.Name = "フィルタ_マ";
            フィルタ_マ.Size = new Size(53, 30);
            フィルタ_マ.TabIndex = 0;
            フィルタ_マ.Text = "マ";
            ...
            フィルタ_ハ.Location = new Point(285, 40);
            フィルタ_ハ.Name = "フィルタ_ハ";
            フィルタ_ハ.Size = new Size(53, 30);
            フィルタ_ハ.TabIndex = 0;
            フィルタ_ハ.Text = "ハ";
            ...
            フィルタ_ナ.Location = new Point(230, 40);
            フィルタ_ナ.Name = "フィルタ_ナ";
            フィルタ_ナ.Size = new Size(53, 30);
            フィルタ_ナ.TabIndex = 0;
            フィルタ_ナ.Text = "ナ";
            ...
            フィルタ_タ.Location = new Point(175, 40);
            フィルタ_タ.Name = "フィルタ_タ";
            フィルタ_タ.Size = new Size(53, 30);
            フィルタ_タ.TabIndex = 0;
            フィルタ_タ.Text = "タ";
            ...
            フィルタ_サ.Location = new Point(120, 40);
            フィルタ_サ.Name = "フィルタ_サ";
            フィルタ_サ.Size = new Size(53, 30);
            フィルタ_サ.TabIndex = 0;
            フィルタ_サ.Text = "サ";
            ...
            キャンセルボタン.Location = new Point(549, 10);
            ...
            検索ボタン.Location = new Point(428, 10);
            検索ボタン.Name = "検索ボタン";
