namespace u_net
{
    partial class F_支払一覧_月間
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(F_支払一覧_月間));
            panel1 = new Panel();
            コマンド入出力 = new Button();
            コマンド支払通知 = new Button();
            コマンド支払 = new Button();
            ...
            コマンド支払先.Text = "支払先";
            toolTip1.SetToolTip(コマンド支払先, "支払先参照");
            ...
            コマンド明細参照.Location = new Point(360, 4);
            コマンド明細参照.Margin = new Padding(0, 2, 0, 2);
            コマンド明細参照.Name = "コマンド明細参照";
            コマンド明細参照.Size = new Size(70, 22);
            コマンド明細参照.TabIndex = 8;
            コマンド明細参照.TabStop = false;
            コマンド明細参照.Text = "明細参照";
            toolTip1.SetToolTip(コマンド明細参照, "支払明細参照");
            コマンド明細参照.UseVisualStyleBackColor = true;
            コマンド明細参照.Click += コマンド明細参照_Click;
            // 
            // コマンド印刷
            // 
            ...
            dataGridView1.Size = new Size(1054, 444);
