namespace u_net
{
    partial class F_売上一覧_全国地区別
    {
        ...
        private void InitializeComponent()
        {
            ...
            // panel2
            // 
            panel2.Controls.Add(自社担当者コード);
            panel2.Controls.Add(集計年度);
            panel2.Controls.Add(自社担当者名);
            ...
            メーカーコード_ラベル.Location = new Point(5, 3);
            メーカーコード_ラベル.Margin = new Padding(0);
            メーカーコード_ラベル.Name = "メーカーコード_ラベル";
            メーカーコード_ラベル.Size = new Size(88, 18);
            ...
            コピーボタン.Location = new Point(654, 4);
            ...
            label2.Location = new Point(798, 4);
            ...
            // 自社担当者コード
            // 
            自社担当者コード.BackColor = Color.White;
            自社担当者コード.DisplayMember = "分類コード";
            ...
            自社担当者コード.Location = new Point(381, 4);
            自社担当者コード.Name = "自社担当者コード";
            自社担当者コード.Size = new Size(71, 21);
            自社担当者コード.TabIndex = 10002;
            自社担当者コード.ValueMember = "分類記号";
            ...
            自社担当者名.Location = new Point(458, 4);
            自社担当者名.Margin = new Padding(3, 2, 3, 2);
            自社担当者名.Name = "自社担当者名";
            自社担当者名.Size = new Size(169, 20);
            自社担当者名.TabIndex = 10003;
            ...
            label5.Location = new Point(280, 4);
            label5.Margin = new Padding(0);
            label5.Name = "label5";
            label5.Size = new Size(98, 17);
            label5.TabIndex = 10001;
            label5.Text = "自社担当者(&C)";
            ...
            Text = "売上一覧_全国地区別";
            FormClosing += F_売上一覧_全国地区別_FormClosing;
            Load += Form_Load;
