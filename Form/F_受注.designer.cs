...
namespace u_net
{
    partial class F_受注
    {
        ...
        private void InitializeComponent()
        {
            ...
            無効日 = new TextBox();
            承認日時 = new TextBox();
            ManufacturingCompletionApprovedDate = new TextBox();
            確定者コード = new TextBox();
            確定日時 = new TextBox();
            label52 = new Label();
            label51 = new Label();
            ...
            帳端処理 = new CheckBox();
            出荷情報 = new GroupBox();
            InvoiceNote = new TextBox();
            PackingSlipNote = new TextBox();
            label41 = new Label();
            label40 = new Label();
            InvoiceFax = new TextBox();
            ReceiptComment = new TextBox();
            InvoiceInput = new TextBox();
            InvoiceFaxCode = new ComboBox();
            ReceiptCommentCode = new ComboBox();
            InvoiceInputCode = new ComboBox();
            PackingSlipInputCode = new ComboBox();
            PaymentConfirmation = new CheckBox();
            InvoiceFaxToNumber = new TextBox();
            InvoiceFaxToContact = new TextBox();
            InvoiceFaxToName = new TextBox();
            PackingSlipInput = new TextBox();
            label32 = new Label();
            label33 = new Label();
            label34 = new Label();
            label35 = new Label();
            ...
            panel1.Controls.Add(コマンド在庫);
            panel1.Controls.Add(コマンド全在庫);
            ...
            label15.Location = new Point(540, 50);
            label15.Margin = new Padding(0);
            label15.Name = "label15";
            label15.Size = new Size(40, 22);
            ...
            備考.Font = new Font("BIZ UDゴシック", 10F, FontStyle.Regular, GraphicsUnit.Point);
            備考.ImeMode = ImeMode.Hiragana;
            備考.Location = new Point(700, 125);
            ...
            label17.Location = new Point(290, 50);
            ...
            入社年月日_ラベル.Location = new Point(2, 100);
            入社年月日_ラベル.Margin = new Padding(0);
            入社年月日_ラベル.Name = "入社年月日_ラベル";
            入社年月日_ラベル.Size = new Size(120, 21);
            入社年月日_ラベル.TabIndex = 246;
            入社年月日_ラベル.Text = "受注日";
            ...
            注文番号.Location = new Point(125, 125);
            注文番号.Margin = new Padding(3, 2, 3, 2);
            注文番号.Multiline = true;
            注文番号.Name = "注文番号";
            注文番号.Size = new Size(250, 22);
            注文番号.TabIndex = 22;
            // 
            // label1
            // 
            ...
            label2.Location = new Point(615, 50);
            ...
            label3.Location = new Point(675, 50);
            ...
            // 生産計画
            // 
            生産計画.BackColor = SystemColors.Control;
            生産計画.Font = new Font("BIZ UDゴシック", 9.75F, FontStyle.Regular, GraphicsUnit.Point);
            生産計画.Location = new Point(695, 70);
            生産計画.Margin = new Padding(3, 2, 3, 2);
            生産計画.Multiline = true;
            生産計画.Name = "生産計画";
            生産計画.ReadOnly = true;
            生産計画.Size = new Size(25, 23);
            生産計画.TabIndex = 253;
            // 
            // label5
            // 
            ...
            label7.Location = new Point(825, 50);
            ...
            label8.Location = new Point(915, 50);
            label8.Margin = new Padding(0);
            label8.Name = "label8";
            label8.Size = new Size(40, 22);
            label8.TabIndex = 256;
            label8.Text = "削除";
            // 
            // 完了承認
            ...
            完了承認.Location = new Point(770, 70);
            完了承認.Margin = new Padding(3, 2, 3, 2);
            完了承認.Multiline = true;
            完了承認.Name = "完了承認";
            完了承認.ReadOnly = true;
            完了承認.Size = new Size(25, 23);
            完了承認.TabIndex = 257;
            // 
            // 在庫締め
            // 
            在庫締め.BackColor = SystemColors.Control;
            在庫締め.Font = new Font("BIZ UDゴシック", 9.75F, FontStyle.Regular, GraphicsUnit.Point);
            在庫締め.Location = new Point(845, 70);
            在庫締め.Margin = new Padding(3, 2, 3, 2);
            在庫締め.Multiline = true;
            在庫締め.Name = "在庫締め";
            在庫締め.ReadOnly = true;
            在庫締め.Size = new Size(25, 23);
            在庫締め.TabIndex = 258;
            // 
            // 削除
            // 
            ...
            発送先登録ボタン.Location = new Point(985, 60);
            発送先登録ボタン.Margin = new Padding(3, 2, 3, 2);
            発送先登録ボタン.Name = "発送先登録ボタン";
            発送先登録ボタン.Size = new Size(80, 30);
            発送先登録ボタン.TabIndex = 10009;
            発送先登録ボタン.TabStop = false;
            発送先登録ボタン.Text = "発送先登録";
            発送先登録ボタン.UseVisualStyleBackColor = true;
            発送先登録ボタン.Click += 発送先登録ボタン_Click;
            // 
            // 受注コード
            // 
            受注コード.BackColor = Color.White;
            受注コード.DisplayMember = "分類コード";
            ...
            受注コード.Location = new Point(125, 50);
            受注コード.Name = "受注コード";
            ...
            // 
            状態.AllowDrop = true;
            状態.AutoEllipsis = true;
            状態.BorderStyle = BorderStyle.FixedSingle;
            状態.Font = new Font("BIZ UDPゴシック", 12F, FontStyle.Bold, GraphicsUnit.Point);
            状態.ForeColor = SystemColors.ActiveCaptionText;
            状態.ImageAlign = ContentAlignment.MiddleLeft;
            状態.Location = new Point(387, 95);
            状態.Margin = new Padding(0);
            状態.Name = "状態";
            状態.Size = new Size(120, 30);
            状態.TabIndex = 10012;
            状態.Text = "非連結";
            状態.TextAlign = ContentAlignment.MiddleCenter;
            // 
            // label9
            // 
            ...
            label9.Location = new Point(2, 150);
            ...
            label10.Location = new Point(2, 175);
            ...
            label12.Font = new Font("BIZ UDPゴシック", 10F, FontStyle.Regular, GraphicsUnit.Point);
            label12.ForeColor = SystemColors.ActiveCaptionText;
            label12.ImageAlign = ContentAlignment.MiddleLeft;
            label12.Location = new Point(2, 225);
            label12.Margin = new Padding(0);
            label12.Name = "label12";
            label12.Size = new Size(120, 22);
            label12.TabIndex = 10016;
            label12.Text = "依頼主名";
            ...
            label13.Location = new Point(2, 225);
            ...
            label14.Location = new Point(2, 250);
            ...
            label16.Location = new Point(2, 275);
            ...
            label18.Location = new Point(2, 300);
            ...
            label20.Location = new Point(2, 350);
            ...
            顧客担当者名.Name = "顧客担当者名";
            顧客担当者名.Size = new Size(400, 22);
            顧客担当者名.TabIndex = 10026;
            // 
            // ClientCode
            // 
            ...
            出荷予定日選択ボタン.Size = new Size(21, 21);
            ...
            納品書送付.Location = new Point(190, 300);
            納品書送付.Margin = new Padding(3, 2, 3, 2);
            納品書送付.Multiline = true;
            納品書送付.Name = "納品書送付";
            納品書送付.ReadOnly = true;
            納品書送付.Size = new Size(150, 22);
            納品書送付.TabIndex = 10033;
            // 
            // 請求書送付コード
            // 
            ...
            請求書送付.Location = new Point(190, 325);
            請求書送付.Margin = new Padding(3, 2, 3, 2);
            請求書送付.Multiline = true;
            請求書送付.Name = "請求書送付";
            請求書送付.ReadOnly = true;
            請求書送付.Size = new Size(150, 22);
            請求書送付.TabIndex = 10035;
            // 
            // 発送方法コード
            // 
            ...
            発送方法.Location = new Point(190, 350);
            発送方法.Margin = new Padding(3, 2, 3, 2);
            発送方法.Multiline = true;
            発送方法.Name = "発送方法";
            発送方法.ReadOnly = true;
            発送方法.Size = new Size(150, 22);
            発送方法.TabIndex = 10037;
            // 
            // label21
            // 
            ...
            label21.Location = new Point(575, 100);
            ...
            自社担当者名.Location = new Point(765, 100);
            自社担当者名.Margin = new Padding(3, 2, 3, 2);
            自社担当者名.Multiline = true;
            自社担当者名.Name = "自社担当者名";
            自社担当者名.ReadOnly = true;
            自社担当者名.Size = new Size(150, 22);
            自社担当者名.TabIndex = 10040;
            // 
            // 自社担当者コード
            // 
            ...
            label6.Location = new Point(575, 200);
            ...
            label22.Location = new Point(575, 125);
            ...
            改訂履歴.Location = new Point(700, 200);
            ...
            label23.Location = new Point(575, 275);
            ...
            // ProductionNotice
            // 
            ProductionNotice.BackColor = Color.White;
            ProductionNotice.Font = new Font("BIZ UDゴシック", 10F, FontStyle.Regular, GraphicsUnit.Point);
            ProductionNotice.ImeMode = ImeMode.Hiragana;
            ProductionNotice.Location = new Point(700, 275);
            ProductionNotice.Margin = new Padding(3, 2, 3, 2);
            ProductionNotice.Multiline = true;
            ProductionNotice.Name = "ProductionNotice";
            ProductionNotice.Size = new Size(377, 72);
            ProductionNotice.TabIndex = 10045;
            // 
            // 受注明細1
            // 
            受注明細1.Location = new Point(10, 380);
            ...
            受注日.Location = new Point(125, 100);
            受注日.Name = "受注日";
            ...
            受注納期.Location = new Point(125, 250);
            受注納期.Name = "受注納期";
            ...
            出荷予定日.Location = new Point(125, 275);
            出荷予定日.Name = "出荷予定日";
            出荷予定日.Size = new Size(150, 24);
            出荷予定日.TabIndex = 10049;
            // 
            // panel2
            // 
            ...
            ProductionPlanned.Multiline = true;
            ProductionPlanned.Name = "ProductionPlanned";
            ProductionPlanned.Size = new Size(150, 22);
            ...
            ManufacturingCompletionApprovedDate.Multiline = true;
            ManufacturingCompletionApprovedDate.Name = "ManufacturingCompletionApprovedDate";
            ManufacturingCompletionApprovedDate.Size = new Size(150, 22);
            ...
            請求コード.Multiline = true;
            請求コード.Name = "請求コード";
            請求コード.Size = new Size(150, 22);
            ...
            InvoiceNote.Multiline = true;
            InvoiceNote.Name = "InvoiceNote";
            InvoiceNote.Size = new Size(350, 22);
            InvoiceNote.TabIndex = 10038;
            ...
            PackingSlipNote.Multiline = true;
            PackingSlipNote.Name = "PackingSlipNote";
            PackingSlipNote.Size = new Size(350, 22);
            PackingSlipNote.TabIndex = 10037;
            ...
            InvoiceFax.Multiline = true;
            InvoiceFax.Name = "InvoiceFax";
            InvoiceFax.ReadOnly = true;
            InvoiceFax.Size = new Size(100, 22);
            InvoiceFax.TabIndex = 10034;
            // 
            // ReceiptComment
            // 
            ...
            ReceiptComment.Multiline = true;
            ReceiptComment.Name = "ReceiptComment";
            ReceiptComment.ReadOnly = true;
            ReceiptComment.Size = new Size(150, 22);
            ReceiptComment.TabIndex = 10033;
            // 
            // InvoiceInput
            // 
            ...
            InvoiceInput.Multiline = true;
            InvoiceInput.Name = "InvoiceInput";
            InvoiceInput.ReadOnly = true;
            InvoiceInput.Size = new Size(150, 22);
            InvoiceInput.TabIndex = 10032;
            // 
            // InvoiceFaxCode
            // 
            ...
            ReceiptCommentCode.TabIndex = 10030;
            ...
            InvoiceInputCode.TabIndex = 10029;
            ...
            PackingSlipInputCode.TabIndex = 10028;
            ...
            PaymentConfirmation.TabIndex = 267;
            ...
            InvoiceFaxToNumber.Multiline = true;
            InvoiceFaxToNumber.Name = "InvoiceFaxToNumber";
            InvoiceFaxToNumber.Size = new Size(350, 22);
            InvoiceFaxToNumber.TabIndex = 265;
            ...
            InvoiceFaxToContact.Multiline = true;
            InvoiceFaxToContact.Name = "InvoiceFaxToContact";
            InvoiceFaxToContact.Size = new Size(350, 22);
            InvoiceFaxToContact.TabIndex = 264;
            ...
            InvoiceFaxToName.Multiline = true;
            InvoiceFaxToName.Name = "InvoiceFaxToName";
            InvoiceFaxToName.Size = new Size(350, 22);
            InvoiceFaxToName.TabIndex = 263;
            ...
            PackingSlipInput.Multiline = true;
            PackingSlipInput.Name = "PackingSlipInput";
            PackingSlipInput.ReadOnly = true;
            PackingSlipInput.Size = new Size(150, 22);
            PackingSlipInput.TabIndex = 262;
            // 
            // label32
            // 
            ...
            発送先メールアドレス.Multiline = true;
            発送先メールアドレス.Name = "発送先メールアドレス";
            発送先メールアドレス.Size = new Size(324, 22);
            発送先メールアドレス.TabIndex = 265;
            // 
            // 発送先担当者名
            // 
            ...
            発送先担当者名.Multiline = true;
            発送先担当者名.Name = "発送先担当者名";
            発送先担当者名.Size = new Size(350, 22);
            発送先担当者名.TabIndex = 264;
            ...
            発送先FAX.Multiline = true;
            発送先FAX.Name = "発送先FAX";
            発送先FAX.Size = new Size(150, 22);
            発送先FAX.TabIndex = 263;
            // 
            // 発送先TEL
            // 
            ...
            発送先TEL.Multiline = true;
            発送先TEL.Name = "発送先TEL";
            発送先TEL.Size = new Size(150, 22);
            発送先TEL.TabIndex = 262;
            // 
            // 発送先住所2
            // 
            ...
            発送先住所2.Multiline = true;
            発送先住所2.Name = "発送先住所2";
            発送先住所2.Size = new Size(350, 22);
            発送先住所2.TabIndex = 261;
            ...
            発送先住所1.Multiline = true;
            発送先住所1.Name = "発送先住所1";
            発送先住所1.Size = new Size(350, 22);
            発送先住所1.TabIndex = 260;
            ...
            発送先郵便番号.Size = new Size(100, 24);
            発送先郵便番号.TabIndex = 253;
        ...
        private Button 発送先登録ボタン;
        private ComboBox 受注コード;
        private Label 状態;
        ...
        private TextBox 請求書送付;
        private ComboBox 発送方法コード;
        private TextBox 発送方法;
        ...
        private Button 受注承認ボタン;
        private Button 受注完了承認ボタン;
        private TextBox 承認者コード;
        private TextBox 完了承認者コード;
        private Panel Page2;
        private Button 戻るボタン;
        private GroupBox 発送先選択;
        private RadioButton 発送先1;
        private RadioButton 発送先2;
        private RadioButton 発送先3;
        private GroupBox 発送先;
        ...
        private TextBox 発送先住所2;
        private TextBox 発送先住所1;
        private Label label31;
        private TextBox 発送先TEL;
        private TextBox 発送先FAX;
        private TextBox 発送先メールアドレス;
        private TextBox 発送先担当者名;
        private Button Email作成ボタン;
        private GroupBox 出荷情報;
        private TextBox InvoiceFaxToNumber;
        private TextBox InvoiceFaxToContact;
        private TextBox InvoiceFaxToName;
        private TextBox PackingSlipInput;
        ...
        private CheckBox PaymentConfirmation;
        private TextBox InvoiceFax;
        private TextBox ReceiptComment;
        private TextBox InvoiceInput;
        private ComboBox InvoiceFaxCode;
        private ComboBox ReceiptCommentCode;
        private ComboBox InvoiceInputCode;
        private ComboBox PackingSlipInputCode;
        ...
        private ComboBox 税端数処理;
        private ComboBox TaxCalcCode;
        ...
        private TextBox ProductionPlanned;
        private TextBox 無効日;
        private TextBox 承認日時;
        private TextBox ManufacturingCompletionApprovedDate;
        private TextBox 確定者コード;
        private TextBox 確定日時;
        private Button 請求予定日選択ボタン;
    }
}
