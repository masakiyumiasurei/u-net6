...
namespace u_net
{
    partial class F_受注
    {
        ...
        private void InitializeComponent()
        {
            ...
            Page1.Controls.Add(自社担当者コード);
            Page1.Controls.Add(label21);
            Page1.Controls.Add(発送方法);
            Page1.Controls.Add(発送方法コード);
            Page1.Controls.Add(請求書送付);
            Page1.Controls.Add(請求書送付コード);
            Page1.Controls.Add(納品書送付);
            Page1.Controls.Add(納品書送付コード);
            Page1.Controls.Add(出荷予定日選択ボタン);
            Page1.Controls.Add(受注納期選択ボタン);
            Page1.Controls.Add(ClientCode);
            Page1.Controls.Add(顧客担当者名);
            Page1.Controls.Add(顧客名);
            Page1.Controls.Add(顧客コード検索ボタン);
            Page1.Controls.Add(顧客コード);
            Page1.Controls.Add(label20);
            Page1.Controls.Add(label19);
            Page1.Controls.Add(label18);
            Page1.Controls.Add(label16);
            Page1.Controls.Add(label14);
            Page1.Controls.Add(label13);
            Page1.Controls.Add(label11);
            Page1.Controls.Add(label10);
            Page1.Controls.Add(label9);
            Page1.Controls.Add(状態);
            Page1.Controls.Add(受注コード);
            Page1.Controls.Add(発送先登録ボタン);
            ...
            Page1.Controls.Add(生産計画);
            Page1.Controls.Add(label3);
            Page1.Controls.Add(承認);
            Page1.Controls.Add(label2);
            Page1.Controls.Add(label1);
            Page1.Controls.Add(受注日選択ボタン);
            Page1.Controls.Add(入社年月日_ラベル);
            Page1.Controls.Add(受注版数);
            Page1.Controls.Add(label17);
            Page1.Controls.Add(確定);
            Page1.Controls.Add(label15);
            ...
            ProductionNotice.Location = new Point(702, 230);
            ...
            // 出荷予定日選択ボタン
            // 
            出荷予定日選択ボタン.Location = new Point(277, 230);
            出荷予定日選択ボタン.Name = "出荷予定日選択ボタン";
            出荷予定日選択ボタン.Size = new Size(21, 21);
            出荷予定日選択ボタン.TabIndex = 10059;
            ...
            // 受注納期選択ボタン
            // 
            受注納期選択ボタン.Location = new Point(277, 205);
            受注納期選択ボタン.Name = "受注納期選択ボタン";
            受注納期選択ボタン.Size = new Size(21, 21);
            受注納期選択ボタン.TabIndex = 10057;
            受注納期選択ボタン.TabStop = false;
            受注納期選択ボタン.Text = "▼";
            ...
            // 顧客コード検索ボタン
            // 
            顧客コード検索ボタン.Location = new Point(277, 105);
            顧客コード検索ボタン.Name = "顧客コード検索ボタン";
            顧客コード検索ボタン.Size = new Size(21, 21);
            顧客コード検索ボタン.TabIndex = 10095;
            ...
            label1.TabIndex = 10074;
            label1.Text = "注文番号";
            label1.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // 受注日選択ボタン
            // 
            受注日選択ボタン.Location = new Point(277, 55);
            受注日選択ボタン.Name = "受注日選択ボタン";
            受注日選択ボタン.Size = new Size(21, 21);
            受注日選択ボタン.TabIndex = 10050;
            受注日選択ボタン.TabStop = false;
            受注日選択ボタン.Text = "▼";
            ...
            注文番号.Validating += 注文番号_Validating;
            注文番号.Validated += 注文番号_Validated;
            // 
            // 備考
            // 
