namespace u_net
{
    partial class F_見積管理_抽出
    {
        ...
        private void InitializeComponent()
        {
            ...
            顧客名.Location = new Point(133, 147);
            顧客名.Name = "顧客名";
            顧客名.Size = new Size(471, 21);
            顧客名.TabIndex = 12;
            ...
            見積日開始.Location = new Point(133, 27);
            見積日開始.Name = "見積日開始";
            見積日開始.Size = new Size(182, 21);
            見積日開始.TabIndex = 0;
            ...
            出荷予定日1ラベル.Location = new Point(29, 27);
            ...
            件名.Location = new Point(133, 187);
            件名.Name = "件名";
            件名.Size = new Size(471, 21);
            件名.TabIndex = 13;
            // 
            // 確定指定
            // 
            ...
            確定指定.Location = new Point(29, 240);
            ...
            抽出ボタン.Location = new Point(362, 596);
            ...
            キャンセルボタン.Location = new Point(498, 596);
            ...
            見積日開始選択ボタン.Location = new Point(322, 27);
            見積日開始選択ボタン.Margin = new Padding(5, 4, 5, 4);
            見積日開始選択ボタン.Name = "見積日開始選択ボタン";
            見積日開始選択ボタン.Size = new Size(29, 31);
            ...
            見積日終了選択ボタン.Location = new Point(576, 27);
            見積日終了選択ボタン.Margin = new Padding(5, 4, 5, 4);
            見積日終了選択ボタン.Name = "見積日終了選択ボタン";
            見積日終了選択ボタン.Size = new Size(29, 31);
            ...
            見積日終了.Location = new Point(383, 27);
            見積日終了.Name = "見積日終了";
            見積日終了.Size = new Size(182, 21);
            見積日終了.TabIndex = 2;
            ...
            顧客コード選択ボタン.Location = new Point(369, 103);
            顧客コード選択ボタン.Margin = new Padding(5, 4, 5, 4);
            顧客コード選択ボタン.Name = "顧客コード選択ボタン";
            顧客コード選択ボタン.Size = new Size(29, 31);
            ...
            顧客コード.Location = new Point(133, 107);
            顧客コード.Name = "顧客コード";
            顧客コード.Size = new Size(228, 21);
            顧客コード.TabIndex = 8;
            ...
            担当者名.Location = new Point(133, 67);
            担当者名.Margin = new Padding(3, 4, 3, 4);
            担当者名.Name = "担当者名";
            担当者名.Size = new Size(214, 21);
            担当者名.TabIndex = 14;
            ...
            削除指定.Location = new Point(29, 453);
            ...
            承認指定.Location = new Point(29, 347);
