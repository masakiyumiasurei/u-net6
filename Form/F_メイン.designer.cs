...
namespace u_net
{
    partial class F_メイン
    {
        ...
        private void InitializeComponent()
        {
            ...
            共通 = new TabPage();
            マスタメンテボタン = new Button();
            休日ボタン = new Button();
            単位登録ボタン = new Button();
            地区マスタメンテボタン = new Button();
            資格認定管理ボタン = new Button();
            旧業務日報ボタン = new Button();
            年間教育計画表ボタン = new Button();
            ファックス送付管理ボタン = new Button();
            月間予定表ボタン = new Button();
            会社情報ボタン = new Button();
            教育訓練資料ボタン = new Button();
            ファックス送付ボタン = new Button();
            ファックス管理ボタン = new Button();
            Plog起動ボタン = new Button();
            資格認定登録ボタン = new Button();
            教育計画管理ボタン = new Button();
            社員登録ボタン = new Button();
            消費税登録ボタン = new Button();
            社員管理ボタン = new Button();
            文書資料 = new TabPage();
            旧文書管理ボタン = new Button();
            経営計画書ボタン = new Button();
            会議報告書_製造ボタン = new Button();
            会議報告書_品質保証ボタン = new Button();
            会議報告書_管理ボタン = new Button();
            会議報告書_業績ボタン = new Button();
            会議報告書_技術ボタン = new Button();
            会議報告書_営業ボタン = new Button();
            文書管理システム起動ボタン = new Button();
            管理 = new TabPage();
            サポート記録ボタン = new Button();
            ISO関連ボタン = new Button();
            総務会計関連ボタン = new Button();
            振込一覧表ボタン = new Button();
            与信情報ボタン = new Button();
            支払管理ボタン = new Button();
            支払一覧_年間ボタン = new Button();
            支払一覧_月間ボタン = new Button();
            支払入力ボタン = new Button();
            売掛一覧ボタン = new Button();
            請求処理ボタン = new Button();
            入金管理ボタン = new Button();
            ...
            製品情報ボタン = new Button();
            部品管理 = new Button();
            メーカー登録ボタン = new Button();
            メーカー管理ボタン = new Button();
            部品集合登録ボタン = new Button();
            部品集合管理ボタン = new Button();
            部品登録ボタン = new Button();
            ユニット登録ボタン = new Button();
            ユニット管理ボタン = new Button();
            製品管理ボタン = new Button();
            製品登録ボタン = new Button();
            製造 = new TabPage();
            ...
            発注管理ボタン = new Button();
            棚卸作業ボタン = new Button();
            部品棚卸管理ボタン = new Button();
            部品棚卸入力ボタン = new Button();
            支払先管理ボタン = new Button();
            仕入先登録ボタン = new Button();
            ...
            共通.Controls.Add(単位登録ボタン);
            共通.Controls.Add(地区マスタメンテボタン);
            共通.Controls.Add(資格認定管理ボタン);
            共通.Controls.Add(旧業務日報ボタン);
            共通.Controls.Add(年間教育計画表ボタン);
            共通.Controls.Add(ファックス送付管理ボタン);
            共通.Controls.Add(月間予定表ボタン);
            共通.Controls.Add(会社情報ボタン);
            共通.Controls.Add(教育訓練資料ボタン);
            共通.Controls.Add(ファックス送付ボタン);
            共通.Controls.Add(ファックス管理ボタン);
            共通.Controls.Add(Plog起動ボタン);
            共通.Controls.Add(資格認定登録ボタン);
            共通.Controls.Add(教育計画管理ボタン);
            ...
            マスタメンテボタン.TabIndex = 10065;
            マスタメンテボタン.TabStop = false;
            マスタメンテボタン.Text = "マスタメンテ";
            マスタメンテボタン.UseVisualStyleBackColor = true;
            マスタメンテボタン.Click += マスタメンテボタン_Click;
            // 
            // 休日ボタン
            // 
            ...
            休日ボタン.TabIndex = 10064;
            休日ボタン.TabStop = false;
            休日ボタン.Text = "休日";
            休日ボタン.UseVisualStyleBackColor = true;
            休日ボタン.Click += 休日ボタン_Click;
            // 
            // 単位登録ボタン
            // 
            ...
            単位登録ボタン.TabIndex = 10063;
            単位登録ボタン.TabStop = false;
            単位登録ボタン.Text = "単位登録";
            単位登録ボタン.UseVisualStyleBackColor = true;
            単位登録ボタン.Click += 単位登録ボタン_Click;
            // 
            // 地区マスタメンテボタン
            // 
            ...
            地区マスタメンテボタン.TabIndex = 10062;
            地区マスタメンテボタン.TabStop = false;
            地区マスタメンテボタン.Text = "地区マスタメンテ";
            地区マスタメンテボタン.UseVisualStyleBackColor = true;
            地区マスタメンテボタン.Click += 地区マスタメンテボタン_Click;
            // 
            // 資格認定管理ボタン
            // 
            ...
            資格認定管理ボタン.TabIndex = 10061;
            資格認定管理ボタン.TabStop = false;
            資格認定管理ボタン.Text = "資格認定管理";
            資格認定管理ボタン.UseVisualStyleBackColor = true;
            資格認定管理ボタン.Click += 資格認定管理ボタン_Click;
            // 
            // 旧業務日報ボタン
            // 
            ...
            旧業務日報ボタン.TabIndex = 10060;
            旧業務日報ボタン.TabStop = false;
            旧業務日報ボタン.Text = "旧業務日報";
            旧業務日報ボタン.UseVisualStyleBackColor = true;
            旧業務日報ボタン.Click += 旧業務日報ボタン_Click;
            // 
            // 年間教育計画表ボタン
            // 
            ...
            年間教育計画表ボタン.TabIndex = 10059;
            年間教育計画表ボタン.TabStop = false;
            年間教育計画表ボタン.Text = "旧教育計画";
            年間教育計画表ボタン.UseVisualStyleBackColor = true;
            年間教育計画表ボタン.Click += 年間教育計画表ボタン_Click;
            // 
            // ファックス送付管理ボタン
            // 
            ...
            ファックス送付管理ボタン.TabIndex = 10038;
            ファックス送付管理ボタン.TabStop = false;
            ファックス送付管理ボタン.Text = "ファックス送付管理";
            ファックス送付管理ボタン.UseVisualStyleBackColor = true;
            ファックス送付管理ボタン.Click += ファックス送付管理ボタン_Click;
            // 
            // 月間予定表ボタン
            // 
            ...
            月間予定表ボタン.TabIndex = 10037;
            月間予定表ボタン.TabStop = false;
            月間予定表ボタン.Text = "月間予定表";
            月間予定表ボタン.UseVisualStyleBackColor = true;
            月間予定表ボタン.Click += 月間予定表ボタン_Click;
            // 
            // 会社情報ボタン
            // 
            ...
            教育訓練資料ボタン.TabIndex = 10035;
            教育訓練資料ボタン.TabStop = false;
            教育訓練資料ボタン.Text = "教育訓練資料";
            教育訓練資料ボタン.UseVisualStyleBackColor = true;
            教育訓練資料ボタン.Click += 教育訓練資料ボタン_Click;
            // 
            // ファックス送付ボタン
            // 
            ...
            ファックス送付ボタン.TabIndex = 10034;
            ファックス送付ボタン.TabStop = false;
            ファックス送付ボタン.Text = "ファックス送付";
            ファックス送付ボタン.UseVisualStyleBackColor = true;
            ファックス送付ボタン.Click += ファックス送付ボタン_Click;
            // 
            // ファックス管理ボタン
            // 
            ...
            ファックス管理ボタン.TabIndex = 10033;
            ファックス管理ボタン.TabStop = false;
            ファックス管理ボタン.Text = "ファックス管理";
            ファックス管理ボタン.UseVisualStyleBackColor = true;
            ファックス管理ボタン.Click += ファックス管理ボタン_Click;
            // 
            // Plog起動ボタン
            // 
            ...
            Plog起動ボタン.TabIndex = 10032;
            Plog起動ボタン.TabStop = false;
            Plog起動ボタン.Text = "Plog起動";
            Plog起動ボタン.UseVisualStyleBackColor = true;
            Plog起動ボタン.Click += Plog起動ボタン_Click;
            // 
            // 資格認定登録ボタン
            // 
            ...
            資格認定登録ボタン.TabIndex = 10031;
            資格認定登録ボタン.TabStop = false;
            資格認定登録ボタン.Text = "資格認定登録";
            資格認定登録ボタン.UseVisualStyleBackColor = true;
            資格認定登録ボタン.Click += 資格認定登録ボタン_Click;
            // 
            // 教育計画管理ボタン
            // 
            ...
            教育計画管理ボタン.TabIndex = 10030;
            教育計画管理ボタン.TabStop = false;
            教育計画管理ボタン.Text = "教育計画管理";
            教育計画管理ボタン.UseVisualStyleBackColor = true;
            教育計画管理ボタン.Click += 教育計画管理ボタン_Click;
            // 
            // 社員登録ボタン
            // 
            ...
            社員登録ボタン.TabIndex = 10029;
            社員登録ボタン.TabStop = false;
            社員登録ボタン.Text = "社員登録";
            社員登録ボタン.UseVisualStyleBackColor = true;
            社員登録ボタン.Click += 社員登録ボタン_Click;
            // 
            // 消費税登録ボタン
            // 
            ...
            消費税登録ボタン.TabIndex = 10028;
            消費税登録ボタン.TabStop = false;
            消費税登録ボタン.Text = "消費税登録";
            消費税登録ボタン.UseVisualStyleBackColor = true;
            消費税登録ボタン.Click += 消費税登録ボタン_Click;
            // 
            // 社員管理ボタン
            // 
            ...
            社員管理ボタン.TabIndex = 10027;
            社員管理ボタン.TabStop = false;
            社員管理ボタン.Text = "社員管理";
            社員管理ボタン.UseVisualStyleBackColor = true;
            社員管理ボタン.Click += 社員管理ボタン_Click;
            // 
            // 文書資料
            // 
            文書資料.BackColor = SystemColors.Control;
            文書資料.Controls.Add(旧文書管理ボタン);
            文書資料.Controls.Add(経営計画書ボタン);
            文書資料.Controls.Add(会議報告書_製造ボタン);
            文書資料.Controls.Add(会議報告書_品質保証ボタン);
            文書資料.Controls.Add(会議報告書_管理ボタン);
            文書資料.Controls.Add(会議報告書_業績ボタン);
            ...
            旧文書管理ボタン.TabIndex = 10058;
            旧文書管理ボタン.TabStop = false;
            旧文書管理ボタン.Text = "旧文書管理";
            旧文書管理ボタン.UseVisualStyleBackColor = true;
            旧文書管理ボタン.Click += 旧文書管理ボタン_Click;
            // 
            // 経営計画書ボタン
            // 
            ...
            経営計画書ボタン.TabIndex = 10057;
            経営計画書ボタン.TabStop = false;
            経営計画書ボタン.Text = "経営計画書";
            経営計画書ボタン.UseVisualStyleBackColor = true;
            経営計画書ボタン.Click += 経営計画書ボタン_Click;
            // 
            // 会議報告書_製造ボタン
            // 
            ...
            会議報告書_製造ボタン.TabIndex = 10056;
            会議報告書_製造ボタン.TabStop = false;
            会議報告書_製造ボタン.Text = "会議報告書（製造部）";
            会議報告書_製造ボタン.UseVisualStyleBackColor = true;
            会議報告書_製造ボタン.Click += 会議報告書_製造ボタン_Click;
            // 
            // 会議報告書_品質保証ボタン
            // 
            ...
            会議報告書_品質保証ボタン.TabIndex = 10055;
            会議報告書_品質保証ボタン.TabStop = false;
            会議報告書_品質保証ボタン.Text = "会議報告書（品質環境）";
            会議報告書_品質保証ボタン.UseVisualStyleBackColor = true;
            会議報告書_品質保証ボタン.Click += 会議報告書_品質保証ボタン_Click;
            // 
            // 会議報告書_管理ボタン
            // 
            ...
            会議報告書_管理ボタン.TabIndex = 10054;
            会議報告書_管理ボタン.TabStop = false;
            会議報告書_管理ボタン.Text = "会議報告書（管理部）";
            会議報告書_管理ボタン.UseVisualStyleBackColor = true;
            会議報告書_管理ボタン.Click += 会議報告書_管理ボタン_Click;
            // 
            // 会議報告書_業績ボタン
            // 
            ...
            会議報告書_業績ボタン.TabIndex = 10053;
            会議報告書_業績ボタン.TabStop = false;
            会議報告書_業績ボタン.Text = "会議報告書（業績）";
            会議報告書_業績ボタン.UseVisualStyleBackColor = true;
            会議報告書_業績ボタン.Click += 会議報告書_業績ボタン_Click;
            // 
            // 会議報告書_技術ボタン
            // 
            ...
            会議報告書_技術ボタン.TabIndex = 10052;
            会議報告書_技術ボタン.TabStop = false;
            会議報告書_技術ボタン.Text = "会議報告書（技術部）";
            会議報告書_技術ボタン.UseVisualStyleBackColor = true;
            会議報告書_技術ボタン.Click += 会議報告書_技術ボタン_Click;
            // 
            // 会議報告書_営業ボタン
            // 
            ...
            会議報告書_営業ボタン.TabIndex = 10051;
            会議報告書_営業ボタン.TabStop = false;
            会議報告書_営業ボタン.Text = "会議報告書（営業部）";
            会議報告書_営業ボタン.UseVisualStyleBackColor = true;
            会議報告書_営業ボタン.Click += 会議報告書_営業ボタン_Click;
            // 
            // 文書管理システム起動ボタン
            // 
            ...
            文書管理システム起動ボタン.TabIndex = 10046;
            文書管理システム起動ボタン.TabStop = false;
            文書管理システム起動ボタン.Text = "文書管理システム";
            文書管理システム起動ボタン.UseVisualStyleBackColor = true;
            文書管理システム起動ボタン.Click += 文書管理システム起動ボタン_Click;
            // 
            // 管理
            // 
            管理.BackColor = SystemColors.Control;
            管理.Controls.Add(サポート記録ボタン);
            管理.Controls.Add(ISO関連ボタン);
            管理.Controls.Add(総務会計関連ボタン);
            管理.Controls.Add(振込一覧表ボタン);
            管理.Controls.Add(与信情報ボタン);
            管理.Controls.Add(支払管理ボタン);
            管理.Controls.Add(支払一覧_年間ボタン);
            管理.Controls.Add(支払一覧_月間ボタン);
            管理.Controls.Add(支払入力ボタン);
            管理.Controls.Add(売掛一覧ボタン);
            ...
            サポート記録ボタン.TabIndex = 10050;
            サポート記録ボタン.TabStop = false;
            サポート記録ボタン.Text = "サポート記録";
            サポート記録ボタン.UseVisualStyleBackColor = true;
            サポート記録ボタン.Click += サポート記録ボタン_Click;
            // 
            // ISO関連ボタン
            // 
            ...
            ISO関連ボタン.TabIndex = 10049;
            ISO関連ボタン.TabStop = false;
            ISO関連ボタン.Text = "ISO関連";
            ISO関連ボタン.UseVisualStyleBackColor = true;
            ISO関連ボタン.Click += ISO関連ボタン_Click;
            // 
            // 総務会計関連ボタン
            // 
            ...
            総務会計関連ボタン.TabIndex = 10048;
            総務会計関連ボタン.TabStop = false;
            総務会計関連ボタン.Text = "総務・会計関連";
            総務会計関連ボタン.UseVisualStyleBackColor = true;
            総務会計関連ボタン.Click += 総務会計関連ボタン_Click;
            // 
            // 振込一覧表ボタン
            // 
            ...
            振込一覧表ボタン.TabIndex = 10047;
            振込一覧表ボタン.TabStop = false;
            振込一覧表ボタン.Text = "振込一覧表";
            振込一覧表ボタン.UseVisualStyleBackColor = true;
            振込一覧表ボタン.Click += 振込一覧表ボタン_Click;
            // 
            // 与信情報ボタン
            // 
            ...
            与信情報ボタン.TabIndex = 10046;
            与信情報ボタン.TabStop = false;
            与信情報ボタン.Text = "与信情報";
            与信情報ボタン.UseVisualStyleBackColor = true;
            与信情報ボタン.Click += 与信情報ボタン_Click;
            // 
            // 支払管理ボタン
            // 
            ...
            支払管理ボタン.TabIndex = 10045;
            支払管理ボタン.TabStop = false;
            支払管理ボタン.Text = "支払管理";
            支払管理ボタン.UseVisualStyleBackColor = true;
            支払管理ボタン.Click += 支払管理ボタン_Click;
            // 
            // 支払一覧_年間ボタン
            // 
            ...
            支払一覧_年間ボタン.TabIndex = 10044;
            支払一覧_年間ボタン.TabStop = false;
            支払一覧_年間ボタン.Text = "支払一覧表（年間）";
            支払一覧_年間ボタン.UseVisualStyleBackColor = true;
            支払一覧_年間ボタン.Click += 支払一覧_年間ボタン_Click;
            // 
            // 支払一覧_月間ボタン
            // 
            ...
            支払一覧_月間ボタン.TabIndex = 10043;
            支払一覧_月間ボタン.TabStop = false;
            支払一覧_月間ボタン.Text = "支払一覧表（月間）";
            支払一覧_月間ボタン.UseVisualStyleBackColor = true;
            支払一覧_月間ボタン.Click += 支払一覧_月間ボタン_Click;
            // 
            // 支払入力ボタン
            // 
            ...
            支払入力ボタン.TabIndex = 10040;
            支払入力ボタン.TabStop = false;
            支払入力ボタン.Text = "支払入力";
            支払入力ボタン.UseVisualStyleBackColor = true;
            支払入力ボタン.Click += 支払入力ボタン_Click;
            // 
            // 売掛一覧ボタン
            // 
            ...
            売掛一覧ボタン.TabIndex = 10039;
            売掛一覧ボタン.TabStop = false;
            売掛一覧ボタン.Text = "売掛一覧";
            売掛一覧ボタン.UseVisualStyleBackColor = true;
            売掛一覧ボタン.Click += 売掛一覧ボタン_Click;
            // 
            // 請求処理ボタン
            // 
            ...
            請求処理ボタン.TabIndex = 10038;
            請求処理ボタン.TabStop = false;
            請求処理ボタン.Text = "請求処理";
            請求処理ボタン.UseVisualStyleBackColor = true;
            請求処理ボタン.Click += 請求処理ボタン_Click;
            // 
            // 入金管理ボタン
            // 
            ...
            入金管理ボタン.TabIndex = 10037;
            入金管理ボタン.TabStop = false;
            入金管理ボタン.Text = "入金管理";
            入金管理ボタン.UseVisualStyleBackColor = true;
            入金管理ボタン.Click += 入金管理ボタン_Click;
            // 
            // 入金入力ボタン
            // 
            ...
            入金入力ボタン.TabIndex = 10036;
            入金入力ボタン.TabStop = false;
            入金入力ボタン.Text = "入金入力";
            入金入力ボタン.UseVisualStyleBackColor = true;
            入金入力ボタン.Click += 入金入力ボタン_Click;
            // 
            // 技術
            // 
            技術.BackColor = SystemColors.Control;
            技術.Controls.Add(製品情報ボタン);
            技術.Controls.Add(部品管理);
            技術.Controls.Add(メーカー登録ボタン);
            技術.Controls.Add(メーカー管理ボタン);
            技術.Controls.Add(部品集合登録ボタン);
            技術.Controls.Add(部品集合管理ボタン);
            技術.Controls.Add(部品登録ボタン);
            技術.Controls.Add(ユニット登録ボタン);
            ...
            製品情報ボタン.TabIndex = 10035;
            製品情報ボタン.TabStop = false;
            製品情報ボタン.Text = "製品情報";
            製品情報ボタン.UseVisualStyleBackColor = true;
            製品情報ボタン.Click += 製品情報ボタン_Click;
            // 
            // 部品管理
            // 
            ...
            部品管理.TabStop = false;
            部品管理.Text = "部品管理";
            部品管理.UseVisualStyleBackColor = true;
            部品管理.Click += 部品管理_Click;
            // 
            // メーカー登録ボタン
            // 
            ...
            メーカー登録ボタン.TabIndex = 10033;
            メーカー登録ボタン.TabStop = false;
            メーカー登録ボタン.Text = "メーカー登録";
            メーカー登録ボタン.UseVisualStyleBackColor = true;
            メーカー登録ボタン.Click += メーカー登録ボタン_Click;
            // 
            // メーカー管理ボタン
            // 
            ...
            メーカー管理ボタン.TabIndex = 10032;
            メーカー管理ボタン.TabStop = false;
            メーカー管理ボタン.Text = "メーカー管理";
            メーカー管理ボタン.UseVisualStyleBackColor = true;
            メーカー管理ボタン.Click += メーカー管理ボタン_Click;
            // 
            // 部品集合登録ボタン
            // 
            ...
            部品集合登録ボタン.TabIndex = 10031;
            部品集合登録ボタン.TabStop = false;
            部品集合登録ボタン.Text = "部品集合登録";
            部品集合登録ボタン.UseVisualStyleBackColor = true;
            部品集合登録ボタン.Click += 部品集合登録ボタン_Click;
            // 
            // 部品集合管理ボタン
            // 
            ...
            部品集合管理ボタン.TabIndex = 10030;
            部品集合管理ボタン.TabStop = false;
            部品集合管理ボタン.Text = "部品集合管理";
            部品集合管理ボタン.UseVisualStyleBackColor = true;
            部品集合管理ボタン.Click += 部品集合管理ボタン_Click;
            // 
            // 部品登録ボタン
            // 
            ...
            部品登録ボタン.TabIndex = 10029;
            部品登録ボタン.TabStop = false;
            部品登録ボタン.Text = "部品登録";
            部品登録ボタン.UseVisualStyleBackColor = true;
            部品登録ボタン.Click += 部品登録ボタン_Click;
            // 
            // ユニット登録ボタン
            // 
            ...
            ユニット登録ボタン.TabIndex = 10028;
            ユニット登録ボタン.TabStop = false;
            ユニット登録ボタン.Text = "ユニット登録";
            ユニット登録ボタン.UseVisualStyleBackColor = true;
            ユニット登録ボタン.Click += ユニット登録ボタン_Click;
            // 
            // ユニット管理ボタン
            // 
            ...
            ユニット管理ボタン.TabIndex = 10027;
            ユニット管理ボタン.TabStop = false;
            ユニット管理ボタン.Text = "ユニット管理";
            ユニット管理ボタン.UseVisualStyleBackColor = true;
            ユニット管理ボタン.Click += ユニット管理ボタン_Click;
            // 
            // 製品管理ボタン
            // 
            ...
            製品管理ボタン.TabIndex = 10026;
            製品管理ボタン.TabStop = false;
            製品管理ボタン.Text = "製品管理";
            製品管理ボタン.UseVisualStyleBackColor = true;
            製品管理ボタン.Click += 製品管理ボタン_Click;
            // 
            // 製品登録ボタン
            // 
            ...
            製品登録ボタン.TabIndex = 10025;
            製品登録ボタン.TabStop = false;
            製品登録ボタン.Text = "製品登録";
            製品登録ボタン.UseVisualStyleBackColor = true;
            製品登録ボタン.Click += 製品登録ボタン_Click;
            // 
            // 製造
            // 
            ...
            製造.Controls.Add(棚卸作業ボタン);
            製造.Controls.Add(部品棚卸管理ボタン);
            製造.Controls.Add(部品棚卸入力ボタン);
            製造.Controls.Add(支払先管理ボタン);
            製造.Controls.Add(仕入先登録ボタン);
            ...
            棚卸作業ボタン.TabIndex = 10037;
            棚卸作業ボタン.TabStop = false;
            棚卸作業ボタン.Text = "棚卸作業";
            棚卸作業ボタン.UseVisualStyleBackColor = true;
            棚卸作業ボタン.Click += 棚卸作業ボタン_Click;
            // 
            // 部品棚卸管理ボタン
            // 
            ...
            部品棚卸管理ボタン.TabIndex = 10036;
            部品棚卸管理ボタン.TabStop = false;
            部品棚卸管理ボタン.Text = "部品棚卸管理";
            部品棚卸管理ボタン.UseVisualStyleBackColor = true;
            部品棚卸管理ボタン.Click += 部品棚卸管理ボタン_Click;
            // 
            // 部品棚卸入力ボタン
            // 
            ...
            部品棚卸入力ボタン.TabIndex = 10035;
            部品棚卸入力ボタン.TabStop = false;
            部品棚卸入力ボタン.Text = "部品棚卸入力";
            部品棚卸入力ボタン.UseVisualStyleBackColor = true;
            部品棚卸入力ボタン.Click += 部品棚卸入力ボタン_Click;
            // 
            // 支払先管理ボタン
            // 
            ...
            支払先管理ボタン.TabIndex = 10034;
            支払先管理ボタン.TabStop = false;
            支払先管理ボタン.Text = "支払先管理";
            支払先管理ボタン.UseVisualStyleBackColor = true;
            支払先管理ボタン.Click += 支払先管理ボタン_Click;
            // 
            // 仕入先登録ボタン
            // 
            ...
            仕入先登録ボタン.TabIndex = 10033;
            仕入先登録ボタン.TabStop = false;
            仕入先登録ボタン.Text = "支払先登録";
            仕入先登録ボタン.UseVisualStyleBackColor = true;
            仕入先登録ボタン.Click += 仕入先登録ボタン_Click;
            // 
            // 仕入先別買掛一覧表ボタン
            // 
            ...
            販売.BackgroundImageLayout = ImageLayout.None;
            ...
            文書資料.ResumeLayout(false);
            管理.ResumeLayout(false);
            技術.ResumeLayout(false);
        ...
        private TabPage 共通;
        private Button マスタメンテボタン;
        private Button 休日ボタン;
        private Button 単位登録ボタン;
        private Button 地区マスタメンテボタン;
        private Button 資格認定管理ボタン;
        private Button 旧業務日報ボタン;
        private Button 年間教育計画表ボタン;
        private Button ファックス送付管理ボタン;
        private Button 月間予定表ボタン;
        private Button 会社情報ボタン;
        private Button 教育訓練資料ボタン;
        private Button ファックス送付ボタン;
        private Button ファックス管理ボタン;
        private Button Plog起動ボタン;
        private Button 資格認定登録ボタン;
        private Button 教育計画管理ボタン;
        private Button 社員登録ボタン;
        private Button 消費税登録ボタン;
        private Button 社員管理ボタン;
        private TabPage 文書資料;
        private Button 旧文書管理ボタン;
        private Button 経営計画書ボタン;
        private Button 会議報告書_製造ボタン;
        private Button 会議報告書_品質保証ボタン;
        private Button 会議報告書_管理ボタン;
        private Button 会議報告書_業績ボタン;
        private Button 会議報告書_技術ボタン;
        private Button 会議報告書_営業ボタン;
        private Button 文書管理システム起動ボタン;
        private TabPage 管理;
        private Button サポート記録ボタン;
        private Button ISO関連ボタン;
        private Button 総務会計関連ボタン;
        private Button 振込一覧表ボタン;
        private Button 与信情報ボタン;
        private Button 支払管理ボタン;
        private Button 支払一覧_年間ボタン;
        private Button 支払一覧_月間ボタン;
        private Button 支払入力ボタン;
        private Button 売掛一覧ボタン;
        private Button 請求処理ボタン;
        private Button 入金管理ボタン;
        private Button 入金入力ボタン;
        private TabPage 技術;
        private Button 製品情報ボタン;
        private Button 部品管理;
        private Button メーカー登録ボタン;
        private Button メーカー管理ボタン;
        private Button 部品集合登録ボタン;
        private Button 部品集合管理ボタン;
        private Button 部品登録ボタン;
        private Button ユニット登録ボタン;
        private Button ユニット管理ボタン;
        private Button 製品管理ボタン;
        private Button 製品登録ボタン;
        private TabPage 製造;
        private Button ProductionSystemButton;
        private Button 発注入力ボタン;
        private Button 発注管理ボタン;
        private Button 棚卸作業ボタン;
        private Button 部品棚卸管理ボタン;
        private Button 部品棚卸入力ボタン;
        private Button 支払先管理ボタン;
        private Button 仕入先登録ボタン;
