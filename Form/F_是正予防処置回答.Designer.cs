namespace u_net
{
    partial class F_是正予防処置回答
    {
        ...
        private void InitializeComponent()
        {
            ...
            予防処置_ラベル.Location = new Point(11, 379);
            ...
            是正処置_ラベル.Location = new Point(11, 257);
            ...
            予防処置.Location = new Point(107, 380);
            予防処置.Margin = new Padding(3, 2, 3, 2);
            予防処置.Multiline = true;
            予防処置.Name = "予防処置";
            予防処置.Size = new Size(353, 130);
            予防処置.TabIndex = 12;
            ...
            是正処置.Location = new Point(107, 257);
            是正処置.Margin = new Padding(3, 2, 3, 2);
            是正処置.Multiline = true;
            是正処置.Name = "是正処置";
            是正処置.Size = new Size(353, 120);
            是正処置.TabIndex = 10;
