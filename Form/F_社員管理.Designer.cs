namespace u_net
{
    partial class F_社員管理
    {
        ...
        private void InitializeComponent()
        {
            ...
            コマンド社員.Location = new Point(333, 5);
            コマンド社員.Margin = new Padding(0, 3, 0, 3);
            コマンド社員.Name = "コマンド社員";
            コマンド社員.Size = new Size(80, 29);
            コマンド社員.TabIndex = 9;
            コマンド社員.Text = "社員";
            toolTip1.SetToolTip(コマンド社員, "社員データの参照");
            コマンド社員.UseVisualStyleBackColor = true;
            コマンド社員.Click += コマンド社員_Click;
            // 
            // コマンドメール
            // 
            ...
            Name = "F_社員管理";
            Text = "社員管理";
            FormClosing += F_社員管理_FormClosing;
            Load += Form_Load;
