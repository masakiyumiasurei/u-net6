namespace u_net
{
    partial class F_ユニット管理
    {
        ...
        private void InitializeComponent()
        {
            ...
            コマンド廃止指定.Location = new Point(428, 4);
            コマンド廃止指定.Margin = new Padding(0, 2, 0, 2);
            コマンド廃止指定.Name = "コマンド廃止指定";
            コマンド廃止指定.Size = new Size(70, 22);
            ...
            コマンドユニット.Location = new Point(291, 4);
            コマンドユニット.Margin = new Padding(0, 2, 0, 2);
            コマンドユニット.Name = "コマンドユニット";
            コマンドユニット.Size = new Size(70, 22);
            コマンドユニット.TabIndex = 9;
            ...
            コマンド部品表.Location = new Point(360, 4);
            コマンド部品表.Margin = new Padding(0, 2, 0, 2);
            コマンド部品表.Name = "コマンド部品表";
            コマンド部品表.Size = new Size(70, 22);
            コマンド部品表.TabIndex = 8;
