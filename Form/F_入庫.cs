    ...
    (Rohs2DocumentStatusCode.SelectedValue != null && (int)Rohs2DocumentStatusCode.SelectedValue == 2))
        ...
        private void コマンドメーカー_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.ActiveControl == this.コマンド仕入先)
                {
            ...
            try
            {
                ...
                switch (controlObject.Name)
                {
                    case "部品コード":
                        ...
                        // コマンド複写.Enabled = true;
                        コマンド削除.Enabled = true;
                        コマンド注文書.Enabled = true;
                        コマンド.Enabled = !(CurrentEdition <= 1);
        ...
        private void Form_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            switch (e.KeyCode)
            {
                ...
                case Keys.F4:
                    ...
                    break;
                case Keys.F5:
                    if (コマンド発注.Enabled) コマンド仕入先_Click(sender, e);
                    break;
