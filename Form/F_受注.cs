...
namespace u_net
{
    public partial class F_受注 : Form
    {
        ...
        private void Form_Load(object sender, EventArgs e)
        {
            ...
            setCombo = true;
            ofn.SetComboBox(受注コード, "SELECT M商品.商品コード as Display ,M商品.商品コード as Value FROM M商品 INNER JOIN M商品明細 ON M商品.商品コード = M商品明細.商品コード " +
        ...
        private bool ErrCheck()
        {
            ...
            if (!FunctionClass.IsError(this.受注コード)) return false;
        ...
        private bool SaveData()
        {
            ...
            SqlTransaction transaction = cn.BeginTransaction();
            {
                ...
                {
                    // M商品データを保存
                    string strwhere = " 商品コード='" + this.受注コード.Text + "' and Revision=" + this.Revision.Text;
                    ...
                    //this.mshomeisaiTableAdapter.Fill(this.newDataSet.M商品明細, this.受注コード.Text);
                ...
                if (this.コマンド登録.Enabled)
                {
                    ...
                    switch (res)
                    {
                        ...
                        case DialogResult.No:
                            ...
                            {
                                Connect();
                                if (!FunctionClass.ReturnCode(cn, "ITM" + this.受注コード.Text))
                                {
                                    MessageBox.Show("エラーのためコードは破棄されました。\n\n商品コード： " + this.受注コード.Text, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                                }
                            }
                            break;
        ...
        public void ChangedData(bool dataChanged)
        {
            ...
            this.受注コード.Enabled = !dataChanged;
        ...
        {
            e.Row.Cells["dgv商品コード"].Value = this.受注コード.Text; //Convert.ToInt32(this.顧客ID);
