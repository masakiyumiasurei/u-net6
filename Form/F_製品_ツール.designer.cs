...
namespace u_net
{
    partial class F_製品_ツール
    {
        ...
        private void InitializeComponent()
        {
            ...
            // 構成番号検索ボタン
            // 
            構成番号検索ボタン.Font = new Font("BIZ UDゴシック", 10F, FontStyle.Regular, GraphicsUnit.Point);
            構成番号検索ボタン.Location = new Point(7, 18);
            構成番号検索ボタン.Margin = new Padding(4);
            構成番号検索ボタン.Name = "構成番号検索ボタン";
            構成番号検索ボタン.RightToLeft = RightToLeft.Yes;
            構成番号検索ボタン.Size = new Size(170, 44);
            構成番号検索ボタン.TabIndex = 1;
            構成番号検索ボタン.Text = "構成番号検索";
            構成番号検索ボタン.UseVisualStyleBackColor = true;
            構成番号検索ボタン.Click += 構成番号検索ボタン_Click;
            // 
            // 全印刷ボタン
            // 
            全印刷ボタン.Font = new Font("BIZ UDゴシック", 10F, FontStyle.Regular, GraphicsUnit.Point);
            全印刷ボタン.Location = new Point(184, 18);
            全印刷ボタン.Margin = new Padding(4);
            全印刷ボタン.Name = "全印刷ボタン";
            全印刷ボタン.RightToLeft = RightToLeft.Yes;
            全印刷ボタン.Size = new Size(170, 44);
            全印刷ボタン.TabIndex = 2;
            全印刷ボタン.Text = "全印刷";
            全印刷ボタン.UseVisualStyleBackColor = true;
            全印刷ボタン.Click += 全印刷ボタン_Click;
            全印刷ボタン.Enter += 全印刷ボタン_Enter;
            // 
            // groupBox1
            // 
