namespace u_net
{
    partial class F_製品材料費参照
    {
        ...
        private void InitializeComponent()
        {
            ...
            閉じるボタン.Location = new Point(296, 435);
            閉じるボタン.Name = "閉じるボタン";
            ...
            // 型式
            // 
            型式.BackColor = SystemColors.Window;
            型式.Font = new Font("BIZ UDゴシック", 9.75F, FontStyle.Regular, GraphicsUnit.Point);
            型式.ImeMode = ImeMode.Hiragana;
            型式.Location = new Point(119, 87);
            型式.Margin = new Padding(3, 2, 3, 2);
            型式.Multiline = true;
            型式.Name = "型式";
            型式.Size = new Size(277, 281);
            型式.TabIndex = 10;
            // 
            // 型番_ラベル
            // 
            ...
            材料費合計.Multiline = true;
            材料費合計.Name = "材料費合計";
            材料費合計.ReadOnly = true;
            材料費合計.Size = new Size(277, 19);
            材料費合計.TabIndex = 14;
            材料費合計.TabStop = false;
            // 
            // F_製品材料費参照
