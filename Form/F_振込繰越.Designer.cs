namespace u_net
{
    partial class F_振込繰越
    {
        ...
        private void InitializeComponent()
        {
            ...
            // 繰越明細_ラベル
            // 
            繰越明細_ラベル.AllowDrop = true;
            繰越明細_ラベル.AutoEllipsis = true;
            繰越明細_ラベル.Font = new Font("BIZ UDゴシック", 9F, FontStyle.Regular, GraphicsUnit.Point);
            繰越明細_ラベル.ForeColor = SystemColors.ActiveCaptionText;
            繰越明細_ラベル.ImageAlign = ContentAlignment.MiddleLeft;
            繰越明細_ラベル.Location = new Point(13, 100);
            繰越明細_ラベル.Margin = new Padding(0);
            繰越明細_ラベル.Name = "繰越明細_ラベル";
            繰越明細_ラベル.Size = new Size(95, 20);
            繰越明細_ラベル.TabIndex = 7;
            繰越明細_ラベル.Text = "繰越明細(&L)";
            繰越明細_ラベル.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // 支払先参照ボタン
            // 
