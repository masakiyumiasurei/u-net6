...
namespace u_net
{
    partial class F_棚卸作業
    {
        ...
        private void InitializeComponent()
        {
            ...
            statusStrip1.Size = new Size(507, 22);
            ...
            // 棚卸登録ボタン
            // 
            棚卸登録ボタン.Font = new Font("BIZ UDゴシック", 9F, FontStyle.Regular, GraphicsUnit.Point);
            棚卸登録ボタン.ForeColor = Color.Black;
            棚卸登録ボタン.Location = new Point(186, 278);
            棚卸登録ボタン.Margin = new Padding(4);
            棚卸登録ボタン.Name = "棚卸登録ボタン";
            棚卸登録ボタン.RightToLeft = RightToLeft.Yes;
            棚卸登録ボタン.Size = new Size(110, 30);
            棚卸登録ボタン.TabIndex = 4;
            棚卸登録ボタン.Text = "棚卸登録(&R)";
            棚卸登録ボタン.UseVisualStyleBackColor = true;
            棚卸登録ボタン.Click += 棚卸登録ボタン_Click;
            // 
            // 作業終了ボタン
            // 
            作業終了ボタン.Font = new Font("BIZ UDゴシック", 9F, FontStyle.Regular, GraphicsUnit.Point);
            作業終了ボタン.ForeColor = Color.Red;
            作業終了ボタン.Location = new Point(314, 278);
            作業終了ボタン.Margin = new Padding(4);
            作業終了ボタン.Name = "作業終了ボタン";
            作業終了ボタン.RightToLeft = RightToLeft.Yes;
            作業終了ボタン.Size = new Size(110, 30);
            作業終了ボタン.TabIndex = 2;
            作業終了ボタン.Text = "作業終了(&E)";
            作業終了ボタン.UseVisualStyleBackColor = true;
            作業終了ボタン.Click += 作業終了ボタン_Click;
            // 
            // 作業開始ボタン
            // 
            作業開始ボタン.Font = new Font("BIZ UDゴシック", 9F, FontStyle.Regular, GraphicsUnit.Point);
            作業開始ボタン.ForeColor = Color.Red;
            作業開始ボタン.Location = new Point(58, 278);
            作業開始ボタン.Margin = new Padding(4);
            作業開始ボタン.Name = "作業開始ボタン";
            作業開始ボタン.RightToLeft = RightToLeft.Yes;
            作業開始ボタン.Size = new Size(110, 30);
            作業開始ボタン.TabIndex = 1;
            作業開始ボタン.Text = "作業開始(&S)";
            作業開始ボタン.UseVisualStyleBackColor = true;
            作業開始ボタン.Click += 作業開始ボタン_Click;
            // 
            // 注釈_ラベル
            // 
            ...
            注釈_ラベル.Location = new Point(10, 224);
            注釈_ラベル.Margin = new Padding(0);
            注釈_ラベル.Name = "注釈_ラベル";
            注釈_ラベル.Size = new Size(467, 43);
            注釈_ラベル.TabIndex = 7;
            注釈_ラベル.Text = "・棚卸作業は作業開始日登録後に開始し、\r\n　作業終了日を登録することで全て完了となります。\r\n・[棚卸登録]は棚卸期間中に実行することができます。";
            // 
            // 棚卸履歴_ラベル
            // 
            棚卸履歴_ラベル.AllowDrop = true;
            棚卸履歴_ラベル.AutoEllipsis = true;
            棚卸履歴_ラベル.Font = new Font("BIZ UDゴシック", 9F, FontStyle.Regular, GraphicsUnit.Point);
            棚卸履歴_ラベル.ForeColor = SystemColors.ActiveCaptionText;
            棚卸履歴_ラベル.ImageAlign = ContentAlignment.MiddleLeft;
            棚卸履歴_ラベル.Location = new Point(10, 15);
            棚卸履歴_ラベル.Margin = new Padding(0);
            棚卸履歴_ラベル.Name = "棚卸履歴_ラベル";
            棚卸履歴_ラベル.Size = new Size(467, 21);
            棚卸履歴_ラベル.TabIndex = 5;
            ...
            閉じるボタン.Location = new Point(397, 335);
