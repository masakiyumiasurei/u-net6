namespace u_net
{
    partial class F_ファックス抽出設定
    {
        ...
        private void InitializeComponent()
        {
            ...
            送信日開始.Location = new Point(131, 20);
            送信日開始.Name = "送信日開始";
            送信日開始.Size = new Size(116, 20);
            送信日開始.TabIndex = 2;
            ...
            送信日_ラベル.Location = new Point(11, 20);
            送信日_ラベル.Margin = new Padding(0);
            送信日_ラベル.Name = "送信日_ラベル";
            送信日_ラベル.Size = new Size(117, 27);
            送信日_ラベル.TabIndex = 1;
            送信日_ラベル.Text = "送信日(&D)";
            ...
            // 抽出ボタン
            // 
            抽出ボタン.Location = new Point(229, 228);
            ...
            // キャンセルボタン
            // 
            キャンセルボタン.Location = new Point(352, 228);
            ...
            groupBox1.Size = new Size(458, 220);
            ...
            送信日終了選択.Location = new Point(425, 21);
            送信日終了選択.Margin = new Padding(5);
            送信日終了選択.Name = "送信日終了選択";
            送信日終了選択.Size = new Size(23, 27);
            ...
            送信日終了.Location = new Point(305, 20);
            送信日終了.Name = "送信日終了";
            送信日終了.Size = new Size(116, 20);
            送信日終了.TabIndex = 3;
            ...
            送信日開始選択.Location = new Point(251, 20);
            送信日開始選択.Margin = new Padding(5);
            送信日開始選択.Name = "送信日開始選択";
            送信日開始選択.Size = new Size(23, 27);
