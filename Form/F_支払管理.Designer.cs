namespace u_net
{
    partial class F_支払管理
    {
        ...
        private void InitializeComponent()
        {
            ...
            コマンド入出力.Location = new Point(815, 5);
            ...
            コマンド承認.Location = new Point(567, 5);
            コマンド承認.Margin = new Padding(0, 3, 0, 3);
            コマンド承認.Name = "コマンド承認";
            コマンド承認.Size = new Size(80, 29);
            コマンド承認.TabIndex = 11;
            ...
            コマンド支払.Location = new Point(333, 5);
            コマンド支払.Margin = new Padding(0, 3, 0, 3);
            コマンド支払.Name = "コマンド支払";
            コマンド支払.Size = new Size(80, 29);
            コマンド支払.TabIndex = 9;
            ...
            コマンドF6.Location = new Point(411, 5);
            コマンドF6.Margin = new Padding(0, 3, 0, 3);
            コマンドF6.Name = "コマンドF6";
            コマンドF6.Size = new Size(80, 29);
            コマンドF6.TabIndex = 8;
            ...
            コマンド保守.Location = new Point(737, 5);
