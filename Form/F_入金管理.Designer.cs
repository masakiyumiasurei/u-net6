namespace u_net
{
    partial class F_入金管理
    {
        ...
        private void InitializeComponent()
        {
            ...
            コマンド領収解除.Location = new Point(496, 4);
            コマンド領収解除.Margin = new Padding(0, 2, 0, 2);
            ...
            コマンド領収書.Location = new Point(428, 4);
            コマンド領収書.Margin = new Padding(0, 2, 0, 2);
            ...
            コマンド操作切替.Location = new Point(647, 4);
            コマンド操作切替.Margin = new Padding(0, 2, 0, 2);
            ...
            一覧.Location = new Point(0, 36);
            一覧.Margin = new Padding(3, 2, 3, 2);
            一覧.Name = "一覧";
            一覧.ReadOnly = true;
            一覧.RowTemplate.Height = 29;
            一覧.Size = new Size(942, 560);
            一覧.TabIndex = 87;
            ...
            一覧.MouseDown += 一覧_MouseDown;
            一覧.MouseUp += 一覧_MouseUp;
            // 
            // panel2
            // 
