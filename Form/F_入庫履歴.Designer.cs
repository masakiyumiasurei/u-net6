namespace u_net
{
    partial class F_入庫履歴
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(F_入庫履歴));
            panel1 = new Panel();
            コマンド検索 = new Button();
            button4 = new Button();
            button3 = new Button();
            ...
            仕入先名.Location = new Point(12, 115);
            仕入先名.Name = "仕入先名";
            ...
            // 担当者名label
            // 
            担当者名label.AllowDrop = true;
            担当者名label.AutoEllipsis = true;
            担当者名label.BorderStyle = BorderStyle.FixedSingle;
            ...
            担当者名label.Location = new Point(375, 89);
            担当者名label.Margin = new Padding(0);
            担当者名label.Name = "担当者名label";
            担当者名label.Size = new Size(145, 23);
            ...
            仕入先担当者名.Location = new Point(344, 115);
            ...
            label2.Location = new Point(532, 89);
            ...
            発注日.Location = new Point(524, 115);
            発注日.Name = "発注日";
            ...
            label4.Location = new Point(698, 89);
            ...
            発注者名.Location = new Point(667, 115);
            発注者名.Name = "発注者名";
            ...
            label5.Location = new Point(880, 89);
            ...
            textBox1.Location = new Point(880, 115);
        ...
        private DataGridViewTextBoxColumn 入庫日;
        private DataGridViewTextBoxColumn 入庫コード;
        private DataGridViewTextBoxColumn 入庫者名;
        private DataGridViewTextBoxColumn 摘要;
        private Label 担当者名label;
