namespace u_net
{
    partial class F_購買申請管理_抽出
    {
        ...
        private void InitializeComponent()
        {
            ...
            基本型式名.Location = new Point(133, 147);
            基本型式名.Name = "基本型式名";
            基本型式名.Size = new Size(471, 20);
            基本型式名.TabIndex = 12;
            // 
            // 申請日開始
            // 
            ...
            申請日開始.Location = new Point(133, 27);
            申請日開始.Name = "申請日開始";
            申請日開始.Size = new Size(182, 20);
            申請日開始.TabIndex = 0;
            ...
            出荷予定日1ラベル.Location = new Point(18, 27);
            出荷予定日1ラベル.Margin = new Padding(0);
            出荷予定日1ラベル.Name = "出荷予定日1ラベル";
            出荷予定日1ラベル.Size = new Size(99, 23);
            ...
            label1.Location = new Point(18, 187);
            ...
            シリーズ名.Location = new Point(133, 187);
            シリーズ名.Name = "シリーズ名";
            シリーズ名.Size = new Size(471, 20);
            シリーズ名.TabIndex = 13;
            // 
            // 終了指定
            // 
            ...
            終了指定.Location = new Point(18, 391);
            終了指定.Margin = new Padding(3, 4, 3, 4);
            終了指定.Name = "終了指定";
            終了指定.Padding = new Padding(3, 4, 3, 4);
            終了指定.Size = new Size(600, 84);
            終了指定.TabIndex = 205;
            終了指定.TabStop = false;
            終了指定.Text = "終了指定(&E)";
            // 
            ...
            終了指定Button3.Location = new Point(397, 29);
            終了指定Button3.Margin = new Padding(3, 4, 3, 4);
            ...
            終了指定Button2.Location = new Point(223, 29);
            終了指定Button2.Margin = new Padding(3, 4, 3, 4);
            ...
            終了指定Button1.Location = new Point(34, 29);
            終了指定Button1.Margin = new Padding(3, 4, 3, 4);
            ...
            完了指定Button3.Location = new Point(397, 29);
            完了指定Button3.Margin = new Padding(3, 4, 3, 4);
            ...
            完了指定Button2.Location = new Point(223, 29);
            完了指定Button2.Margin = new Padding(3, 4, 3, 4);
            ...
            完了指定Button1.Location = new Point(34, 29);
            完了指定Button1.Margin = new Padding(3, 4, 3, 4);
            ...
            抽出ボタン.Location = new Point(355, 719);
            ...
            キャンセルボタン.Location = new Point(491, 719);
            ...
            申請日開始選択.Location = new Point(322, 27);
            申請日開始選択.Margin = new Padding(5, 4, 5, 4);
            申請日開始選択.Name = "申請日開始選択";
            申請日開始選択.Size = new Size(29, 31);
            申請日開始選択.TabIndex = 1;
            ...
            申請日終了選択.Location = new Point(576, 27);
            申請日終了選択.Margin = new Padding(5, 4, 5, 4);
            申請日終了選択.Name = "申請日終了選択";
            申請日終了選択.Size = new Size(29, 31);
            申請日終了選択.TabIndex = 3;
            ...
            出荷予定日2ラベル.Location = new Point(355, 27);
            ...
            申請日終了.Location = new Point(383, 27);
            申請日終了.Name = "申請日終了";
            申請日終了.Size = new Size(182, 20);
            申請日終了.TabIndex = 2;
            ...
            購買納期終了.Location = new Point(383, 67);
            購買納期終了.Name = "購買納期終了";
            購買納期終了.Size = new Size(182, 20);
            購買納期終了.TabIndex = 6;
            ...
            購買納期終了選択.Location = new Point(576, 67);
            購買納期終了選択.Margin = new Padding(5, 4, 5, 4);
            購買納期終了選択.Name = "購買納期終了選択";
            購買納期終了選択.Size = new Size(29, 31);
            購買納期終了選択.TabIndex = 7;
            ...
            購買納期開始選択.Location = new Point(322, 67);
            購買納期開始選択.Margin = new Padding(5, 4, 5, 4);
            購買納期開始選択.Name = "購買納期開始選択";
            購買納期開始選択.Size = new Size(29, 31);
            購買納期開始選択.TabIndex = 5;
            ...
            購買納期開始.Location = new Point(133, 67);
            購買納期開始.Name = "購買納期開始";
            購買納期開始.Size = new Size(182, 20);
            購買納期開始.TabIndex = 4;
            ...
            出荷予定日終了.Location = new Point(383, 107);
            出荷予定日終了.Name = "出荷予定日終了";
            出荷予定日終了.Size = new Size(182, 20);
            出荷予定日終了.TabIndex = 10;
            ...
            出荷予定日終了選択.Location = new Point(576, 107);
            出荷予定日終了選択.Margin = new Padding(5, 4, 5, 4);
            出荷予定日終了選択.Name = "出荷予定日終了選択";
            出荷予定日終了選択.Size = new Size(29, 31);
            ...
            出荷予定日開始選択.Location = new Point(322, 107);
            出荷予定日開始選択.Margin = new Padding(5, 4, 5, 4);
            出荷予定日開始選択.Name = "出荷予定日開始選択";
            出荷予定日開始選択.Size = new Size(29, 31);
            ...
            出荷予定日開始.Location = new Point(133, 107);
            出荷予定日開始.Name = "出荷予定日開始";
            出荷予定日開始.Size = new Size(182, 20);
            出荷予定日開始.TabIndex = 8;
            ...
            申請者コード_ラベル.Location = new Point(18, 227);
            申請者コード_ラベル.Margin = new Padding(0);
            申請者コード_ラベル.Name = "申請者コード_ラベル";
            申請者コード_ラベル.Size = new Size(114, 23);
            ...
            申請者コード.Location = new Point(133, 227);
            申請者コード.Margin = new Padding(3, 4, 3, 4);
            申請者コード.Name = "申請者コード";
            申請者コード.Size = new Size(214, 28);
            申請者コード.TabIndex = 14;
            ...
            削除指定.Location = new Point(18, 604);
            ...
            承認指定.Location = new Point(18, 284);
            承認指定.Margin = new Padding(3, 4, 3, 4);
            承認指定.Name = "承認指定";
            承認指定.Padding = new Padding(3, 4, 3, 4);
            承認指定.Size = new Size(600, 84);
            承認指定.TabIndex = 203;
            承認指定.TabStop = false;
            承認指定.Text = "承認指定(&A)";
            // 
