...
namespace u_net
{
    partial class F_商品back
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(F_商品back));
            ...
            コマンド終了.Location = new Point(1337, 6);
            コマンド終了.Margin = new Padding(3, 2, 3, 2);
            コマンド終了.Name = "コマンド終了";
            コマンド終了.Size = new Size(116, 31);
            コマンド終了.TabIndex = 0;
            コマンド終了.Text = "終了";
            ...
            コマンド登録.Location = new Point(1216, 6);
            コマンド登録.Margin = new Padding(3, 2, 3, 2);
            コマンド登録.Name = "コマンド登録";
            コマンド登録.Size = new Size(116, 31);
            コマンド登録.TabIndex = 1;
            コマンド登録.Text = "登録";
            ...
            dataGridView1.Size = new Size(2019, 261);
            ...
            button4.Location = new Point(852, 6);
            ...
            button3.Location = new Point(731, 6);
            ...
            コマンド製品.Location = new Point(609, 6);
            コマンド製品.Margin = new Padding(3, 2, 3, 2);
            コマンド製品.Name = "コマンド製品";
            コマンド製品.Size = new Size(116, 31);
            コマンド製品.TabIndex = 9;
            ...
            コマンドシリーズ.Location = new Point(488, 6);
            コマンドシリーズ.Margin = new Padding(3, 2, 3, 2);
            コマンドシリーズ.Name = "コマンドシリーズ";
            コマンドシリーズ.Size = new Size(116, 31);
            コマンドシリーズ.TabIndex = 8;
            コマンドシリーズ.Text = "シリーズ";
            ...
            コマンド確定.Location = new Point(1095, 6);
            コマンド確定.Margin = new Padding(3, 2, 3, 2);
            コマンド確定.Name = "コマンド確定";
            コマンド確定.Size = new Size(116, 31);
            コマンド確定.TabIndex = 7;
            コマンド確定.Text = "確定";
            ...
            コマンド承認.Location = new Point(973, 6);
            コマンド承認.Margin = new Padding(3, 2, 3, 2);
            コマンド承認.Name = "コマンド承認";
            コマンド承認.Size = new Size(116, 31);
            コマンド承認.TabIndex = 6;
            コマンド承認.Text = "承認";
            ...
            コマンド削除.Location = new Point(367, 6);
            コマンド削除.Margin = new Padding(3, 2, 3, 2);
            コマンド削除.Name = "コマンド削除";
            コマンド削除.Size = new Size(116, 31);
            コマンド削除.TabIndex = 5;
            コマンド削除.Text = "削除";
            ...
            コマンド複写.Location = new Point(245, 6);
            コマンド複写.Margin = new Padding(3, 2, 3, 2);
            コマンド複写.Name = "コマンド複写";
            コマンド複写.Size = new Size(116, 31);
            コマンド複写.TabIndex = 4;
            コマンド複写.Text = "複写";
            ...
            コマンド修正.Location = new Point(124, 6);
            コマンド修正.Margin = new Padding(3, 2, 3, 2);
            コマンド修正.Name = "コマンド修正";
            コマンド修正.Size = new Size(116, 31);
            コマンド修正.TabIndex = 3;
            コマンド修正.Text = "修正";
            ...
            statusStrip1.Size = new Size(2045, 25);
            ...
            button1.Location = new Point(1808, 287);
            ...
            label17.Location = new Point(1169, 287);
            label17.Margin = new Padding(0);
            label17.Name = "label17";
            label17.Size = new Size(576, 96);
            label17.TabIndex = 187;
            label17.Text = "※在庫管理しない商品の場合、シリーズ欄は何も入力しないでください。\r\n\r\n※商品の型番は受注時に確定されます。\r\n\r\n※商品を構成する際、型式名を排他的に選択させるには、各明細行の間へ型式名に半角文字でハイフンを３つ（---）入力した明細行を挿入してください。";
            ...
            label16.Location = new Point(1115, 241);
            ...
            ComposedChipMount.Location = new Point(1236, 245);
            ...
            削除.Location = new Point(1235, 204);
            ...
            label15.Location = new Point(1148, 206);
            ...
            更新者名.Location = new Point(1380, 168);
            ...
            更新者コード.DataBindings.Add(new Binding("Text", M商品BindingSource, "更新者コード", true));
            更新者コード.Enabled = false;
            更新者コード.Font = new Font("BIZ UDゴシック", 9.75F, FontStyle.Regular, GraphicsUnit.Point);
            更新者コード.Location = new Point(1235, 167);
            ...
            label14.Location = new Point(1148, 169);
            ...
            label13.Location = new Point(1148, 132);
            ...
            更新日時.DataBindings.Add(new Binding("Text", M商品BindingSource, "更新日時", true));
            更新日時.Enabled = false;
            更新日時.Font = new Font("BIZ UDゴシック", 9.75F, FontStyle.Regular, GraphicsUnit.Point);
            更新日時.Location = new Point(1236, 132);
            ...
            作成者名.Location = new Point(1380, 94);
            ...
            作成者コード.DataBindings.Add(new Binding("Text", M商品BindingSource, "作成者コード", true));
            作成者コード.Enabled = false;
            作成者コード.Font = new Font("BIZ UDゴシック", 9.75F, FontStyle.Regular, GraphicsUnit.Point);
            作成者コード.Location = new Point(1235, 93);
            ...
            label10.Location = new Point(1148, 58);
            ...
            作成日時.DataBindings.Add(new Binding("Text", M商品BindingSource, "作成日時", true));
            作成日時.Enabled = false;
            作成日時.Font = new Font("BIZ UDゴシック", 9.75F, FontStyle.Regular, GraphicsUnit.Point);
            作成日時.Location = new Point(1236, 58);
            ...
            label9.Location = new Point(55, 261);
            ...
            分類内容.Location = new Point(312, 174);
            分類内容.Margin = new Padding(3, 2, 3, 2);
            分類内容.Multiline = true;
            分類内容.Name = "分類内容";
            分類内容.ReadOnly = true;
            分類内容.Size = new Size(313, 23);
            分類内容.TabIndex = 171;
            // 
            // 商品分類コード
            // 
            ...
            // シリーズコード
            // 
            シリーズコード.DataBindings.Add(new Binding("Text", v商品ヘッダBindingSource, "シリーズコード", true));
            ...
            label7.Location = new Point(52, 115);
            ...
            シリーズ名.DataBindings.Add(new Binding("Text", M商品BindingSource, "シリーズ名", true));
            シリーズ名.Enabled = false;
            シリーズ名.Font = new Font("BIZ UDゴシック", 9.75F, FontStyle.Regular, GraphicsUnit.Point);
            シリーズ名.Location = new Point(312, 114);
            シリーズ名.Margin = new Padding(3, 2, 3, 2);
            シリーズ名.Multiline = true;
            シリーズ名.Name = "シリーズ名";
            シリーズ名.ReadOnly = true;
            シリーズ名.Size = new Size(313, 23);
            シリーズ名.TabIndex = 166;
            シリーズ名.Visible = false;
            // 
            // 商品名
            ...
            商品名.DataBindings.Add(new Binding("Text", v商品ヘッダBindingSource, "商品名", true));
            商品名.Font = new Font("BIZ UDゴシック", 9.75F, FontStyle.Regular, GraphicsUnit.Point);
            商品名.Location = new Point(144, 80);
            商品名.Margin = new Padding(3, 2, 3, 2);
            商品名.Multiline = true;
            商品名.Name = "商品名";
            商品名.Size = new Size(768, 23);
            商品名.TabIndex = 165;
            // 
            // label5
            // 
            ...
            ClientName.DataBindings.Add(new Binding("Text", M商品BindingSource, "ClientName", true));
            ClientName.Font = new Font("BIZ UDゴシック", 9.75F, FontStyle.Regular, GraphicsUnit.Point);
            ClientName.Location = new Point(144, 360);
            ClientName.Margin = new Padding(3, 2, 3, 2);
            ClientName.Multiline = true;
            ClientName.Name = "ClientName";
            ClientName.Size = new Size(768, 23);
            ...
            label3.Location = new Point(55, 361);
            ...
            品名.DataBindings.Add(new Binding("Text", M商品BindingSource, "品名", true));
            品名.Font = new Font("BIZ UDゴシック", 9.75F, FontStyle.Regular, GraphicsUnit.Point);
            品名.Location = new Point(144, 146);
            品名.Margin = new Padding(3, 2, 3, 2);
            品名.MaxLength = 24;
            品名.Multiline = true;
            品名.Name = "品名";
            品名.Size = new Size(768, 23);
            品名.TabIndex = 161;
            ...
            Discontinued.DataBindings.Add(new Binding("Checked", M商品BindingSource, "Discontinued", true));
            Discontinued.Font = new Font("BIZ UDゴシック", 9F, FontStyle.Regular, GraphicsUnit.Point);
            Discontinued.Location = new Point(80, 395);
            Discontinued.Margin = new Padding(4, 3, 4, 3);
            Discontinued.Name = "Discontinued";
            Discontinued.Size = new Size(48, 16);
            Discontinued.TabIndex = 160;
            Discontinued.Text = "廃止";
            ...
            IsUnit.DataBindings.Add(new Binding("Checked", M商品BindingSource, "IsUnit", true));
            IsUnit.Font = new Font("BIZ UDゴシック", 9F, FontStyle.Regular, GraphicsUnit.Point);
            IsUnit.Location = new Point(1137, 429);
            IsUnit.Margin = new Padding(4, 3, 4, 3);
            IsUnit.Name = "IsUnit";
            IsUnit.Size = new Size(72, 16);
            IsUnit.TabIndex = 159;
            IsUnit.Text = "ユニット";
            ...
            数量単位名.Location = new Point(312, 323);
            ...
            label2.Location = new Point(55, 324);
            ...
            掛率有効.DataBindings.Add(new Binding("Checked", M商品BindingSource, "掛率有効", true));
            ...
            // 性別label
            // 
            性別label.AllowDrop = true;
            性別label.AutoEllipsis = true;
            ...
            性別label.Location = new Point(52, 287);
            ...
            備考.DataBindings.Add(new Binding("Text", M商品BindingSource, "備考", true));
            備考.Font = new Font("BIZ UDゴシック", 9.75F, FontStyle.Regular, GraphicsUnit.Point);
            備考.Location = new Point(144, 427);
            備考.Margin = new Padding(3, 2, 3, 2);
            備考.Multiline = true;
            備考.Name = "備考";
            備考.Size = new Size(921, 51);
            備考.TabIndex = 152;
            // 
            // label11
            // 
            ...
            label11.Location = new Point(55, 147);
            ...
            FlowCategoryName.DataBindings.Add(new Binding("Text", M商品BindingSource, "FlowCategoryName", true));
            FlowCategoryName.Enabled = false;
            FlowCategoryName.Font = new Font("BIZ UDゴシック", 9.75F, FontStyle.Regular, GraphicsUnit.Point);
            FlowCategoryName.Location = new Point(312, 286);
            ...
            FlowCategoryName.Size = new Size(313, 23);
            ...
            label4.Location = new Point(55, 53);
            ...
            // 商品コード
            // 
            商品コード.BackColor = Color.White;
            商品コード.DataBindings.Add(new Binding("Text", M商品BindingSource, "シリーズ名", true));
            商品コード.Enabled = false;
            商品コード.Font = new Font("BIZ UDゴシック", 9.75F, FontStyle.Regular, GraphicsUnit.Point);
            商品コード.Location = new Point(628, 199);
            商品コード.Margin = new Padding(3, 2, 3, 2);
            商品コード.Multiline = true;
            商品コード.Name = "商品コード";
            商品コード.ReadOnly = true;
            商品コード.Size = new Size(313, 23);
            商品コード.TabIndex = 193;
            商品コード.Visible = false;
            // 
            // F_商品back
            ...
            Controls.Add(ComposedChipMount);
            Controls.Add(削除);
        ...
        private System.Windows.Forms.Button コマンドシリーズ;
        ...
        private System.Windows.Forms.TextBox ComposedChipMount;
        ...
        private System.Windows.Forms.TextBox シリーズ名;
