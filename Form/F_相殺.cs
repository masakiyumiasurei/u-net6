...
namespace u_net
{
    public partial class F_相殺 : Form
    {
        ...
        private void SetList(DateTime TotalDate, string PayeeCode)
        {
            ...
            string strSQL = "SELECT 明細番号, 相殺金額, 備考  " +
                            "FROM T相殺 " +
            ...
            dataGridView1.Columns[2].Width = 4480 / twipperdot;
        ...
        private void 削除ボタン_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string strSQL = "UPDATE T相殺 SET 無効日時=GETDATE(),無効者コード='" +
        ...
        private void 追加ボタン_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(相殺金額.Text)) return;
            ...
            try
            {
                ...
                string strSQL = "INSERT T相殺 SELECT '" +
                    dtm支払年月.ToString("yyyy/MM/dd") + "','" + str支払先コード + "'," +
                    "ISNULL(MAX(明細番号)+1,1)," +
                    "'" + 備考.Text + "'," +
                    相殺金額.Text + ",NULL,GETDATE(),'" + CommonConstants.LoginUserCode + "',NULL,NULL" +
                    " FROM T相殺 WHERE 支払年月='" + dtm支払年月.ToString("yyyy/MM/dd") +
                    "' AND 支払先コード='" + str支払先コード + "'";
        ...
        private void F_相殺_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.Return:
