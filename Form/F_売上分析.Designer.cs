namespace u_net
{
    partial class F_売上分析
    {
        ...
        private Button 担当者別売上一覧ボタン;
        private Button 顧客別売上一覧ボタン;
        private Button 顧客グループ別売上一覧ボタン;
        private Button 売上一覧_売上地区別ボタン;
        private Button 全国地区別売上一覧ボタン;
        private Button 依頼主別売上一覧ボタン;
        private Button 顧客毎依頼主別売上一覧ボタン;
        private Button 区分別年度売上一覧ボタン;
        private Button 売上一覧_区分別ボタン;
        private Button 売上明細参照ボタン;
        private Button 依頼主毎シリーズ別売上一覧ボタン;
        private Button 顧客グループ別売上明細一覧ボタン;
        private Button 受注残推移グラフボタン;
