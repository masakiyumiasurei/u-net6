namespace u_net
{
    partial class F_購買申請管理
    {
        ...
        private void InitializeComponent()
        {
            ...
            // コマンド購買申請
            // 
            コマンド購買申請.Font = new Font("BIZ UDPゴシック", 9F, FontStyle.Regular, GraphicsUnit.Point);
            コマンド購買申請.ForeColor = Color.Blue;
            コマンド購買申請.ImageAlign = ContentAlignment.BottomLeft;
            コマンド購買申請.Location = new Point(333, 5);
            コマンド購買申請.Margin = new Padding(0, 3, 0, 3);
            コマンド購買申請.Name = "コマンド購買申請";
            コマンド購買申請.Size = new Size(80, 29);
            コマンド購買申請.TabIndex = 1;
            コマンド購買申請.Text = "購申請";
            toolTip1.SetToolTip(コマンド購買申請, "購買申請データ参照");
            コマンド購買申請.UseVisualStyleBackColor = true;
            コマンド購買申請.Click += コマンド購買申請_Click;
            // 
            // button2
            // 
            ...
            button2.Location = new Point(411, 5);
            ...
            コマンド入出力.Location = new Point(739, 5);
            ...
            コマンド保守.Location = new Point(817, 5);
            コマンド保守.Margin = new Padding(0, 3, 0, 3);
            コマンド保守.Name = "コマンド保守";
            コマンド保守.Size = new Size(80, 29);
            コマンド保守.TabIndex = 8;
            コマンド保守.Text = "保守";
            ...
            購買申請明細.Location = new Point(0, 83);
            購買申請明細.Name = "購買申請明細";
            購買申請明細.ReadOnly = true;
            購買申請明細.RowTemplate.Height = 29;
            購買申請明細.Size = new Size(1341, 674);
            購買申請明細.TabIndex = 1;
            ...
            panel2.Name = "panel2";
            panel2.Size = new Size(1341, 36);
            panel2.TabIndex = 88;
            // 
            // 税込合計金額
            // 
            税込合計金額.Location = new Point(854, 5);
            税込合計金額.Name = "税込合計金額";
            ...
            label4.Location = new Point(757, 8);
            label4.Name = "label4";
            ...
            前々月ボタン.Location = new Point(3, 5);
            前々月ボタン.Margin = new Padding(3, 4, 3, 4);
            前々月ボタン.Name = "前々月ボタン";
            前々月ボタン.Size = new Size(86, 31);
            前々月ボタン.TabIndex = 1;
            前々月ボタン.Text = "－ ２ <<";
            前々月ボタン.UseVisualStyleBackColor = true;
            前々月ボタン.Click += 前々月ボタン_Click;
            // 
            // 前月ボタン
            // 
            前月ボタン.Font = new Font("BIZ UDPゴシック", 9F, FontStyle.Regular, GraphicsUnit.Point);
            前月ボタン.Location = new Point(86, 5);
            前月ボタン.Margin = new Padding(3, 4, 3, 4);
            前月ボタン.Name = "前月ボタン";
            前月ボタン.Size = new Size(86, 31);
            前月ボタン.TabIndex = 2;
            前月ボタン.Text = "－ １ <<";
            前月ボタン.UseVisualStyleBackColor = true;
            前月ボタン.Click += 前月ボタン_Click;
            // 
            // 当月ボタン
            // 
            当月ボタン.Font = new Font("BIZ UDPゴシック", 9F, FontStyle.Regular, GraphicsUnit.Point);
            当月ボタン.Location = new Point(169, 5);
            当月ボタン.Margin = new Padding(3, 4, 3, 4);
            当月ボタン.Name = "当月ボタン";
            当月ボタン.Size = new Size(86, 31);
            当月ボタン.TabIndex = 3;
            当月ボタン.Text = "当月";
            当月ボタン.UseVisualStyleBackColor = true;
            当月ボタン.Click += 当月ボタン_Click;
            // 
            // 翌月ボタン
            // 
            翌月ボタン.Font = new Font("BIZ UDPゴシック", 9F, FontStyle.Regular, GraphicsUnit.Point);
            翌月ボタン.Location = new Point(253, 5);
            翌月ボタン.Margin = new Padding(3, 4, 3, 4);
            翌月ボタン.Name = "翌月ボタン";
            翌月ボタン.Size = new Size(86, 31);
            翌月ボタン.TabIndex = 4;
            翌月ボタン.Text = ">> ＋ １";
            翌月ボタン.UseVisualStyleBackColor = true;
            翌月ボタン.Click += 翌月ボタン_Click;
            // 
            // 翌々月ボタン
            // 
            翌々月ボタン.Font = new Font("BIZ UDPゴシック", 9F, FontStyle.Regular, GraphicsUnit.Point);
            翌々月ボタン.Location = new Point(336, 5);
            翌々月ボタン.Margin = new Padding(3, 4, 3, 4);
            翌々月ボタン.Name = "翌々月ボタン";
            翌々月ボタン.Size = new Size(86, 31);
            翌々月ボタン.TabIndex = 5;
            翌々月ボタン.Text = ">> ＋ ２";
            翌々月ボタン.UseVisualStyleBackColor = true;
            翌々月ボタン.Click += 翌々月ボタン_Click;
            // 
            // Next3Button
            // 
            Next3Button.Font = new Font("BIZ UDPゴシック", 9F, FontStyle.Regular, GraphicsUnit.Point);
            Next3Button.Location = new Point(417, 5);
            Next3Button.Margin = new Padding(3, 4, 3, 4);
            Next3Button.Name = "Next3Button";
            Next3Button.Size = new Size(86, 31);
            Next3Button.TabIndex = 6;
            Next3Button.Text = ">> ＋ ３";
            Next3Button.UseVisualStyleBackColor = true;
            Next3Button.Click += Next3Button_Click;
            // 
            // Next4Button
            // 
            Next4Button.Font = new Font("BIZ UDPゴシック", 9F, FontStyle.Regular, GraphicsUnit.Point);
            Next4Button.Location = new Point(501, 5);
            Next4Button.Margin = new Padding(3, 4, 3, 4);
            Next4Button.Name = "Next4Button";
            Next4Button.Size = new Size(86, 31);
        ...
        private Button 前々月ボタン;
        private Button 前月ボタン;
        private Button 当月ボタン;
        private Button 翌月ボタン;
        private Button 翌々月ボタン;
