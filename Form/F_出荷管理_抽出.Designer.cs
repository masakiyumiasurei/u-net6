namespace u_net
{
    partial class F_出荷管理_抽出
    {
        ...
        private void InitializeComponent()
        {
            ...
            出荷コード開始.Location = new Point(136, 23);
            出荷コード開始.Name = "出荷コード開始";
            出荷コード開始.Size = new Size(116, 20);
            出荷コード開始.TabIndex = 2;
            ...
            出荷コード_ラベル.Location = new Point(19, 23);
            出荷コード_ラベル.Margin = new Padding(0);
            出荷コード_ラベル.Name = "出荷コード_ラベル";
            出荷コード_ラベル.Size = new Size(109, 25);
            ...
            // 抽出ボタン
            // 
            抽出ボタン.Location = new Point(217, 587);
            ...
            // キャンセルボタン
            // 
            キャンセルボタン.Location = new Point(342, 587);
            ...
            // 出荷予定日開始選択ボタン
            // 
            出荷予定日開始選択ボタン.Location = new Point(255, 55);
            出荷予定日開始選択ボタン.Margin = new Padding(5);
            出荷予定日開始選択ボタン.Name = "出荷予定日開始選択ボタン";
            出荷予定日開始選択ボタン.Size = new Size(24, 28);
            ...
            出荷予定日開始.Location = new Point(136, 56);
            出荷予定日開始.Name = "出荷予定日開始";
            出荷予定日開始.Size = new Size(116, 20);
            出荷予定日開始.TabIndex = 5;
            ...
            出荷予定日終了.Location = new Point(304, 56);
            出荷予定日終了.Name = "出荷予定日終了";
            出荷予定日終了.Size = new Size(116, 20);
            出荷予定日終了.TabIndex = 6;
            ...
            // 出荷予定日終了選択ボタン
            // 
            出荷予定日終了選択ボタン.Location = new Point(423, 55);
            出荷予定日終了選択ボタン.Margin = new Padding(5);
            出荷予定日終了選択ボタン.Name = "出荷予定日終了選択ボタン";
            出荷予定日終了選択ボタン.Size = new Size(24, 28);
            ...
            シリアル番号指定.Location = new Point(19, 185);
            シリアル番号指定.Margin = new Padding(3, 4, 3, 4);
            シリアル番号指定.Name = "シリアル番号指定";
            シリアル番号指定.Padding = new Padding(3, 4, 3, 4);
            シリアル番号指定.Size = new Size(439, 141);
            ...
            シリアル番号終了.Location = new Point(297, 53);
            シリアル番号終了.Name = "シリアル番号終了";
            シリアル番号終了.Size = new Size(116, 20);
            シリアル番号終了.TabIndex = 3;
            ...
            label7.Location = new Point(272, 52);
            ...
            シリアル番号開始.Location = new Point(154, 53);
            シリアル番号開始.Name = "シリアル番号開始";
            シリアル番号開始.Size = new Size(116, 20);
            シリアル番号開始.TabIndex = 2;
            ...
            シリアル番号_ラベル.Location = new Point(32, 53);
            シリアル番号_ラベル.Margin = new Padding(0);
            シリアル番号_ラベル.Name = "シリアル番号_ラベル";
            シリアル番号_ラベル.Size = new Size(109, 25);
            ...
            シリアル番号指定3.Location = new Point(14, 109);
            シリアル番号指定3.Margin = new Padding(3, 4, 3, 4);
            ...
            シリアル番号指定2.Location = new Point(14, 80);
            シリアル番号指定2.Margin = new Padding(3, 4, 3, 4);
            ...
            シリアル番号指定1.Location = new Point(14, 29);
            シリアル番号指定1.Margin = new Padding(3, 4, 3, 4);
            ...
            発送先名_ラベル.Location = new Point(19, 333);
            発送先名_ラベル.Margin = new Padding(0);
            発送先名_ラベル.Name = "発送先名_ラベル";
            発送先名_ラベル.Size = new Size(109, 28);
            ...
            出荷コード終了.Location = new Point(278, 23);
            出荷コード終了.Name = "出荷コード終了";
            出荷コード終了.Size = new Size(116, 20);
            出荷コード終了.TabIndex = 3;
            ...
            出荷予定日_ラベル.Location = new Point(19, 57);
            出荷予定日_ラベル.Margin = new Padding(0);
            出荷予定日_ラベル.Name = "出荷予定日_ラベル";
            出荷予定日_ラベル.Size = new Size(109, 25);
            ...
            label3.Location = new Point(279, 56);
            ...
            label4.Location = new Point(253, 87);
            ...
            受注コード終了.Location = new Point(278, 88);
            受注コード終了.Name = "受注コード終了";
            受注コード終了.Size = new Size(116, 20);
            受注コード終了.TabIndex = 9;
            ...
            受注コード開始.Location = new Point(136, 88);
            受注コード開始.Name = "受注コード開始";
            受注コード開始.Size = new Size(116, 20);
            受注コード開始.TabIndex = 8;
            ...
            型番.Location = new Point(136, 120);
            型番.Name = "型番";
            型番.Size = new Size(322, 20);
            型番.TabIndex = 11;
            ...
            型番_ラベル.Location = new Point(19, 121);
            型番_ラベル.Margin = new Padding(0);
            型番_ラベル.Name = "型番_ラベル";
            型番_ラベル.Size = new Size(109, 25);
            型番_ラベル.TabIndex = 10;
            型番_ラベル.Text = "型番(&M)";
            ...
            型番詳細.Location = new Point(136, 152);
            型番詳細.Name = "型番詳細";
            型番詳細.Size = new Size(322, 20);
            型番詳細.TabIndex = 13;
            ...
            発送先名.Location = new Point(136, 333);
            発送先名.Name = "発送先名";
            発送先名.Size = new Size(322, 20);
            発送先名.TabIndex = 16;
            ...
            顧客コード_ラベル.Location = new Point(19, 365);
            顧客コード_ラベル.Margin = new Padding(0);
            顧客コード_ラベル.Name = "顧客コード_ラベル";
            顧客コード_ラベル.Size = new Size(109, 25);
            ...
            顧客コード.Location = new Point(136, 365);
            顧客コード.Name = "顧客コード";
            顧客コード.Size = new Size(116, 20);
            顧客コード.TabIndex = 18;
            ...
            // 顧客コード検索ボタン
            // 
            顧客コード検索ボタン.Location = new Point(255, 364);
            顧客コード検索ボタン.Margin = new Padding(5);
            顧客コード検索ボタン.Name = "顧客コード検索ボタン";
            顧客コード検索ボタン.Size = new Size(24, 28);
            ...
            顧客名_ラベル.Location = new Point(19, 400);
            顧客名_ラベル.Margin = new Padding(0);
            顧客名_ラベル.Name = "顧客名_ラベル";
            顧客名_ラベル.Size = new Size(109, 25);
            顧客名_ラベル.TabIndex = 19;
            顧客名_ラベル.Text = "顧客名";
            ...
            顧客名.Location = new Point(136, 399);
            顧客名.Name = "顧客名";
            顧客名.ReadOnly = true;
            顧客名.Size = new Size(322, 20);
            顧客名.TabIndex = 21027;
            顧客名.TabStop = false;
            ...
            作業終了指定.Location = new Point(19, 437);
            作業終了指定.Margin = new Padding(3, 4, 3, 4);
            作業終了指定.Name = "作業終了指定";
            作業終了指定.Padding = new Padding(3, 4, 3, 4);
            作業終了指定.Size = new Size(439, 141);
            作業終了指定.TabIndex = 19;
            ...
            // 作業終了日終了選択ボタン
            // 
            作業終了日終了選択ボタン.Location = new Point(407, 52);
            作業終了日終了選択ボタン.Margin = new Padding(5);
            作業終了日終了選択ボタン.Name = "作業終了日終了選択ボタン";
            作業終了日終了選択ボタン.Size = new Size(24, 28);
            ...
            // 作業終了日開始選択ボタン
            // 
            作業終了日開始選択ボタン.Location = new Point(241, 53);
            作業終了日開始選択ボタン.Margin = new Padding(5);
            作業終了日開始選択ボタン.Name = "作業終了日開始選択ボタン";
            作業終了日開始選択ボタン.Size = new Size(24, 28);
            ...
            作業終了日終了.Location = new Point(288, 53);
            作業終了日終了.Name = "作業終了日終了";
            作業終了日終了.Size = new Size(116, 20);
            作業終了日終了.TabIndex = 3;
            ...
            label2.Location = new Point(263, 52);
            ...
            作業終了日開始.Location = new Point(122, 53);
            作業終了日開始.Name = "作業終了日開始";
            作業終了日開始.Size = new Size(116, 20);
            作業終了日開始.TabIndex = 2;
            ...
            作業終了日_ラベル.Location = new Point(32, 53);
            作業終了日_ラベル.Margin = new Padding(0);
            作業終了日_ラベル.Name = "作業終了日_ラベル";
            作業終了日_ラベル.Size = new Size(94, 25);
            ...
            作業終了指定3.Location = new Point(14, 109);
            作業終了指定3.Margin = new Padding(3, 4, 3, 4);
            ...
            作業終了指定2.Location = new Point(14, 80);
            作業終了指定2.Margin = new Padding(3, 4, 3, 4);
            ...
            作業終了指定1.Location = new Point(14, 29);
            作業終了指定1.Margin = new Padding(3, 4, 3, 4);
