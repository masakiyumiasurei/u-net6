namespace u_net
{
    partial class F_出荷管理_抽出
    {
        ...
        private void InitializeComponent()
        {
            ...
            出荷予定日開始選択ボタン.Margin = new Padding(4);
            ...
            出荷予定日終了選択ボタン.Margin = new Padding(4);
            ...
            受注コード終了.TabIndex = 9;
            受注コード終了.KeyPress += 受注コード終了_KeyPress;
            ...
            受注コード開始.TabIndex = 8;
            受注コード開始.KeyPress += 受注コード開始_KeyPress;
            ...
            作業終了日終了選択ボタン.Margin = new Padding(4);
            ...
            作業終了日開始選択ボタン.Margin = new Padding(4);
