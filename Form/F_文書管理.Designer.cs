namespace u_net
{
    partial class F_文書管理
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(F_文書管理));
            panel1 = new Panel();
            コマンド入出力 = new Button();
            コマンドF8 = new Button();
            コマンドF7 = new Button();
            ...
            panel1.Controls.Add(コマンド文書参照);
            panel1.Controls.Add(コマンドリンク);
            ...
            // コマンド文書参照
            // 
            コマンド文書参照.Font = new Font("BIZ UDPゴシック", 9F, FontStyle.Regular, GraphicsUnit.Point);
            コマンド文書参照.ForeColor = Color.Blue;
            コマンド文書参照.ImageAlign = ContentAlignment.BottomLeft;
            コマンド文書参照.Location = new Point(291, 4);
            コマンド文書参照.Margin = new Padding(0, 2, 0, 2);
            コマンド文書参照.Name = "コマンド文書参照";
            コマンド文書参照.Size = new Size(70, 22);
            コマンド文書参照.TabIndex = 9;
            コマンド文書参照.TabStop = false;
            コマンド文書参照.Text = "参照";
            toolTip1.SetToolTip(コマンド文書参照, "選択文書の参照");
            コマンド文書参照.UseVisualStyleBackColor = true;
            コマンド文書参照.Click += コマンド文書参照_Click;
            // 
            // コマンドリンク
            // 
            ...
            コマンドリンク.Location = new Point(360, 4);
            コマンドリンク.Margin = new Padding(0, 2, 0, 2);
            コマンドリンク.Name = "コマンドリンク";
            コマンドリンク.Size = new Size(70, 22);
            コマンドリンク.TabIndex = 8;
            ...
            Text = "文書管理";
            toolTip1.SetToolTip(this, "抽出設定");
            FormClosing += F_支払管理_FormClosing;
            Load += F_支払管理_Load;
            KeyDown += F_文書管理_KeyDown;
            Resize += Form_Resize;
