namespace u_net
{
    partial class F_売上計画
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(F_売上計画));
            panel1 = new Panel();
            コマンド登録 = new Button();
            コマンドF8 = new Button();
            コマンド重要顧客 = new Button();
            ...
            panel1.Controls.Add(コマンド重要顧客);
            panel1.Controls.Add(コマンド顧客参照);
            panel1.Controls.Add(コマンドコピー);
            ...
            toolTip1.SetToolTip(コマンドF8, "支払通知書のプレビュー");
            コマンドF8.UseVisualStyleBackColor = true;
            // 
            // コマンド重要顧客
            // 
            コマンド重要顧客.Font = new Font("BIZ UDPゴシック", 9F, FontStyle.Regular, GraphicsUnit.Point);
            コマンド重要顧客.ForeColor = Color.Blue;
            コマンド重要顧客.ImageAlign = ContentAlignment.BottomLeft;
            コマンド重要顧客.Location = new Point(428, 4);
            コマンド重要顧客.Margin = new Padding(0, 2, 0, 2);
            コマンド重要顧客.Name = "コマンド重要顧客";
            コマンド重要顧客.Size = new Size(70, 22);
            コマンド重要顧客.TabIndex = 10;
            コマンド重要顧客.TabStop = false;
            コマンド重要顧客.Text = "重要顧客";
            toolTip1.SetToolTip(コマンド重要顧客, "重要顧客の登録");
            コマンド重要顧客.UseVisualStyleBackColor = true;
            コマンド重要顧客.Click += コマンド重要顧客_Click;
            // 
            // コマンド顧客参照
            // 
            コマンド顧客参照.Font = new Font("BIZ UDPゴシック", 9F, FontStyle.Regular, GraphicsUnit.Point);
            コマンド顧客参照.ForeColor = Color.Blue;
            コマンド顧客参照.ImageAlign = ContentAlignment.BottomLeft;
            コマンド顧客参照.Location = new Point(291, 4);
            コマンド顧客参照.Margin = new Padding(0, 2, 0, 2);
            コマンド顧客参照.Name = "コマンド顧客参照";
            コマンド顧客参照.Size = new Size(70, 22);
            コマンド顧客参照.TabIndex = 9;
            コマンド顧客参照.TabStop = false;
            コマンド顧客参照.Text = "顧客参照";
            toolTip1.SetToolTip(コマンド顧客参照, "顧客の参照");
            コマンド顧客参照.UseVisualStyleBackColor = true;
            コマンド顧客参照.Click += コマンド顧客参照_Click;
            // 
            // コマンドコピー
            // 
            コマンドコピー.Enabled = false;
            コマンドコピー.Font = new Font("BIZ UDPゴシック", 9F, FontStyle.Regular, GraphicsUnit.Point);
            コマンドコピー.ForeColor = Color.Blue;
            コマンドコピー.ImageAlign = ContentAlignment.BottomLeft;
            コマンドコピー.Location = new Point(360, 4);
            コマンドコピー.Margin = new Padding(0, 2, 0, 2);
            コマンドコピー.Name = "コマンドコピー";
            コマンドコピー.Size = new Size(70, 22);
            コマンドコピー.TabIndex = 8;
            コマンドコピー.TabStop = false;
            コマンドコピー.Text = "コピー";
            toolTip1.SetToolTip(コマンドコピー, "選択データのコピー");
            コマンドコピー.UseVisualStyleBackColor = true;
            コマンドコピー.Click += コマンドコピー_Click;
            コマンドコピー.Enter += コマンドコピー_Enter;
            コマンドコピー.Leave += コマンドコピー_Leave;
            // 
            // コマンド出力
            // 
            ...
            コマンド出力.Location = new Point(577, 4);
            コマンド出力.Margin = new Padding(0, 2, 0, 2);
            コマンド出力.Name = "コマンド出力";
            コマンド出力.Size = new Size(70, 22);
            コマンド出力.TabIndex = 7;
            コマンド出力.Text = "出力";
            toolTip1.SetToolTip(コマンド出力, "外部ファイルへ出力");
            ...
            // 自社担当者_ラベル
            // 
            自社担当者_ラベル.AllowDrop = true;
            自社担当者_ラベル.AutoEllipsis = true;
            ...
            自社担当者_ラベル.TabIndex = 3;
            自社担当者_ラベル.Text = "自社担当者(&C)";
            自社担当者_ラベル.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // 自社担当者コード
            // 
