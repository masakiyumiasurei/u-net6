namespace u_net
{
    partial class F_商品管理
    {
        ...
        private void InitializeComponent()
        {
            ...
            button4.Location = new Point(577, 6);
            ...
            button3.Location = new Point(495, 6);
            ...
            コマンドメール.Location = new Point(413, 6);
            コマンドメール.Margin = new Padding(1, 2, 1, 2);
            コマンドメール.Name = "コマンドメール";
            コマンドメール.Size = new Size(80, 30);
            コマンドメール.TabIndex = 9;
            コマンドメール.Text = "メール";
            ...
            コマンドメーカー.Location = new Point(331, 6);
            コマンドメーカー.Margin = new Padding(1, 2, 1, 2);
            コマンドメーカー.Name = "コマンドメーカー";
            コマンドメーカー.Size = new Size(80, 30);
            コマンドメーカー.TabIndex = 8;
            コマンドメーカー.Text = "メーカー";
            ...
            コマンド印刷.Location = new Point(741, 6);
            コマンド印刷.Margin = new Padding(1, 2, 1, 2);
            コマンド印刷.Name = "コマンド印刷";
            コマンド印刷.Size = new Size(80, 30);
            コマンド印刷.TabIndex = 7;
            コマンド印刷.Text = "印刷";
            ...
            コマンド更新.Location = new Point(659, 6);
            コマンド更新.Margin = new Padding(1, 2, 1, 2);
            コマンド更新.Name = "コマンド更新";
            コマンド更新.Size = new Size(80, 30);
            コマンド更新.TabIndex = 6;
            コマンド更新.Text = "更新";
            ...
            コマンド全表示.Location = new Point(249, 6);
            コマンド全表示.Margin = new Padding(1, 2, 1, 2);
            コマンド全表示.Name = "コマンド全表示";
            コマンド全表示.Size = new Size(80, 30);
            コマンド全表示.TabIndex = 5;
            コマンド全表示.Text = "全表示";
            ...
            コマンド初期化.Location = new Point(167, 6);
            コマンド初期化.Margin = new Padding(1, 2, 1, 2);
            コマンド初期化.Name = "コマンド初期化";
            コマンド初期化.Size = new Size(80, 30);
            コマンド初期化.TabIndex = 4;
            コマンド初期化.Text = "初期化";
            ...
            コマンド検索.Location = new Point(85, 6);
            コマンド検索.Margin = new Padding(1, 2, 1, 2);
            コマンド検索.Name = "コマンド検索";
            コマンド検索.Size = new Size(80, 30);
            コマンド検索.TabIndex = 3;
            コマンド検索.Text = "検索";
            ...
            コマンド抽出.Location = new Point(3, 6);
            コマンド抽出.Margin = new Padding(1, 2, 1, 2);
            コマンド抽出.Name = "コマンド抽出";
            コマンド抽出.Size = new Size(80, 30);
            コマンド抽出.TabIndex = 2;
            コマンド抽出.Text = "抽出";
            ...
            コマンド入出力.Location = new Point(823, 6);
            コマンド入出力.Margin = new Padding(1, 2, 1, 2);
            コマンド入出力.Name = "コマンド入出力";
            コマンド入出力.Size = new Size(80, 30);
            コマンド入出力.TabIndex = 1;
            コマンド入出力.Text = "入出力";
            ...
            コマンド終了.Location = new Point(905, 6);
            コマンド終了.Margin = new Padding(1, 2, 1, 2);
            コマンド終了.Name = "コマンド終了";
            コマンド終了.Size = new Size(80, 30);
            コマンド終了.TabIndex = 0;
            コマンド終了.Text = "終了";
            ...
            // 表示件数
            // 
            表示件数.Location = new Point(118, 491);
            表示件数.Name = "表示件数";
            ...
            label1.Location = new Point(43, 494);
            label1.Name = "label1";
            ...
            label2.Location = new Point(223, 494);
            label2.Name = "label2";
            ...
            dataGridView1.Size = new Size(1226, 443);
