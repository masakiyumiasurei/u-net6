...
namespace u_net
{
    public partial class F_購買 : Form
    {
    ...
    //        }
        ...
        {
            toolStripStatusLabel1.Text = "■購買元となる購買申請データを選択します。";
        }

        private void 購買申請コード_Leave(object sender, EventArgs e)
        {
            toolStripStatusLabel1.Text = "各種項目の説明";
        }
        ...
        {
            toolStripStatusLabel1.Text = "■購買対象製品の製品コードを入力します。　■ダブルクリックすると対象の製品データを参照できます。";
        }
        ...
        {
            toolStripStatusLabel1.Text = "■各発注部品の買掛区分を選択します。　■入力内容は発注データへ反映されます。";
        }
