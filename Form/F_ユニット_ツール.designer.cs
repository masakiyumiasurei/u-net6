...
namespace u_net
{
    partial class F_ユニット_ツール
    {
        ...
        private void InitializeComponent()
        {
            ...
            閉じるボタン.Location = new Point(270, 166);
            ...
            statusStrip1.Location = new Point(0, 198);
            ...
            // 部品一括変更ボタン
            // 
            部品一括変更ボタン.Font = new Font("BIZ UDゴシック", 10F, FontStyle.Regular, GraphicsUnit.Point);
            部品一括変更ボタン.Location = new Point(7, 18);
            部品一括変更ボタン.Margin = new Padding(4);
            部品一括変更ボタン.Name = "部品一括変更ボタン";
            部品一括変更ボタン.RightToLeft = RightToLeft.Yes;
            部品一括変更ボタン.Size = new Size(170, 44);
            部品一括変更ボタン.TabIndex = 1;
            部品一括変更ボタン.Text = "部品一括変更";
            部品一括変更ボタン.UseVisualStyleBackColor = true;
            部品一括変更ボタン.Click += 部品一括変更ボタン_Click;
            // 
            // 使用製品検索ボタン
            // 
            使用製品検索ボタン.Font = new Font("BIZ UDゴシック", 10F, FontStyle.Regular, GraphicsUnit.Point);
            使用製品検索ボタン.Location = new Point(184, 18);
            使用製品検索ボタン.Margin = new Padding(4);
            使用製品検索ボタン.Name = "使用製品検索ボタン";
            使用製品検索ボタン.RightToLeft = RightToLeft.Yes;
            使用製品検索ボタン.Size = new Size(170, 44);
            使用製品検索ボタン.TabIndex = 2;
            使用製品検索ボタン.Text = "使用製品検索";
            使用製品検索ボタン.UseVisualStyleBackColor = true;
            使用製品検索ボタン.Click += 使用製品検索ボタン_Click;
            // 
            // groupBox1
            // 
            ...
            // 材料費の強制取得ボタン
            // 
            材料費の強制取得ボタン.Font = new Font("BIZ UDゴシック", 10F, FontStyle.Regular, GraphicsUnit.Point);
            材料費の強制取得ボタン.Location = new Point(7, 70);
            材料費の強制取得ボタン.Margin = new Padding(4);
            材料費の強制取得ボタン.Name = "材料費の強制取得ボタン";
            材料費の強制取得ボタン.RightToLeft = RightToLeft.Yes;
            材料費の強制取得ボタン.Size = new Size(170, 44);
            材料費の強制取得ボタン.TabIndex = 3;
