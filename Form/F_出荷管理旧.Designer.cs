namespace u_net
{
    partial class F_出荷管理旧
    {
        ...
        private void InitializeComponent()
        {
            ...
            // panel3
            // 
            panel3.Controls.Add(合計金額);
            panel3.Controls.Add(label1);
            panel3.Controls.Add(合計数量);
            panel3.Controls.Add(label3);
            panel3.Controls.Add(有効件数);
            ...
            // panel4
            // 
            panel4.Controls.Add(前日出荷分ボタン);
            panel4.Controls.Add(最終製品検査記録印刷ボタン);
            panel4.Controls.Add(初期表示ボタン);
            panel4.Controls.Add(最終製品検査記録プレビューボタン);
            panel4.Controls.Add(本日出荷分ボタン);
            panel4.Controls.Add(注釈_ラベル);
