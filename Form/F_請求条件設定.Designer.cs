namespace u_net
{
    partial class F_請求条件設定
    {
        ...
        private void InitializeComponent()
        {
            ...
            顧客検索ボタン = new Button();
            締日分類 = new GroupBox();
            指定締日 = new RadioButton();
            月次締日 = new RadioButton();
            顧客コード = new TextBox();
            顧客名 = new TextBox();
            ...
            請求締日選択ボタン.Margin = new Padding(4, 4, 4, 4);
            ...
            顧客検索ボタン.Margin = new Padding(4, 4, 4, 4);
            ...
            // 締日分類
            // 
            締日分類.Controls.Add(指定締日);
            締日分類.Controls.Add(月次締日);
            ...
            // 
            指定締日.AutoSize = true;
            指定締日.Location = new Point(101, 22);
            指定締日.Name = "指定締日";
            指定締日.Size = new Size(71, 16);
            指定締日.TabIndex = 2;
            指定締日.TabStop = true;
            指定締日.Text = "指定締日";
            指定締日.UseVisualStyleBackColor = true;
            // 
            // 月次締日
            // 
            月次締日.AutoSize = true;
            月次締日.Location = new Point(24, 22);
            月次締日.Name = "月次締日";
            月次締日.Size = new Size(71, 16);
            月次締日.TabIndex = 1;
            月次締日.TabStop = true;
            月次締日.Text = "月次締日";
            月次締日.UseVisualStyleBackColor = true;
            // 
            // 顧客コード
            // 
        ...
        private RadioButton 指定締日;
        private RadioButton 月次締日;
    }
}