...
namespace u_net
{
    public partial class F_棚卸登録抽出設定 : Form
    {
        ...
        private void Form_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                F_棚卸登録 frmTarget = Application.OpenForms.OfType<F_棚卸登録>().FirstOrDefault();
        ...
        private void F_棚卸登録抽出設定_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.Return:
