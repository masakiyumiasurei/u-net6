...
namespace u_net
{
    partial class F_ユニット参照
    {
        ...
        private void InitializeComponent()
        {
            ...
            品名 = new TextBox();
            品名_ラベル = new Label();
            ユニットコード = new ComboBox();
            ユニットコードラベル = new Label();
            仕入先2_ラベル = new Label();
            識別コード_ラベル = new Label();
            無効者コード = new TextBox();
            ...
            コマンド登録.Text = "登録";
            toolTip1.SetToolTip(コマンド登録, "ユニットデータの確定");
            ...
            // コマンド部品定数表
            // 
            コマンド部品定数表.Font = new Font("BIZ UDPゴシック", 9F, FontStyle.Regular, GraphicsUnit.Point);
            コマンド部品定数表.ForeColor = Color.Blue;
            コマンド部品定数表.ImageAlign = ContentAlignment.BottomLeft;
            コマンド部品定数表.Location = new Point(440, 5);
            コマンド部品定数表.Margin = new Padding(3, 2, 3, 2);
            コマンド部品定数表.Name = "コマンド部品定数表";
            コマンド部品定数表.Size = new Size(70, 20);
            ...
            コマンド部品表.Location = new Point(370, 5);
            コマンド部品表.Margin = new Padding(3, 2, 3, 2);
            コマンド部品表.Name = "コマンド部品表";
            コマンド部品表.Size = new Size(70, 20);
            ...
            コマンド部品.Location = new Point(300, 5);
            ...
            廃止_ラベル.Location = new Point(9, 173);
            廃止_ラベル.Margin = new Padding(0);
            廃止_ラベル.Name = "廃止_ラベル";
            廃止_ラベル.Size = new Size(95, 42);
            廃止_ラベル.TabIndex = 15;
            廃止_ラベル.Text = "廃止(&A)";
            // 
            // 型番_ラベル
            ...
            型番_ラベル.Location = new Point(9, 96);
            型番_ラベル.Margin = new Padding(0);
            型番_ラベル.Name = "型番_ラベル";
            型番_ラベル.Size = new Size(100, 17);
            型番_ラベル.TabIndex = 8;
            型番_ラベル.Text = "型番(&M)";
            ...
            // ユニットコードラベル
            // 
            ユニットコードラベル.AllowDrop = true;
            ユニットコードラベル.AutoEllipsis = true;
            ユニットコードラベル.Font = new Font("BIZ UDゴシック", 9F, FontStyle.Regular, GraphicsUnit.Point);
            ユニットコードラベル.ForeColor = SystemColors.ActiveCaptionText;
            ユニットコードラベル.ImageAlign = ContentAlignment.MiddleLeft;
            ユニットコードラベル.Location = new Point(9, 50);
            ユニットコードラベル.Margin = new Padding(0);
            ユニットコードラベル.Name = "ユニットコードラベル";
            ユニットコードラベル.Size = new Size(108, 17);
            ユニットコードラベル.TabIndex = 1;
            ユニットコードラベル.Text = "ユニットコード(&C)";
            ユニットコードラベル.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // 仕入先2_ラベル
            // 
            ...
            更新日時.Location = new Point(810, 94);
            ...
            作成者コード.Location = new Point(810, 70);
            ...
            作成者名.Location = new Point(849, 70);
            ...
            識別コード.Location = new Point(122, 120);
            ...
            確定日時.Location = new Point(600, 48);
            ...
            更新者名.Location = new Point(849, 118);
            ...
            更新者コード.Location = new Point(810, 118);
            ...
            label5.Location = new Point(150, 147);
            ...
            Controls.Add(品名);
            Controls.Add(品名_ラベル);
            Controls.Add(ユニットコード);
            Controls.Add(ユニットコードラベル);
            Controls.Add(仕入先2_ラベル);
            Controls.Add(コマンド終了);
            Controls.Add(コマンド登録);
            Controls.Add(コマンドツール);
            Controls.Add(コマンド部品定数表);
            Controls.Add(コマンド部品表);
            Controls.Add(コマンド部品);
            Controls.Add(コマンド確定);
            Controls.Add(コマンド承認);
            Controls.Add(コマンド削除);
