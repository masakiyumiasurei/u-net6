namespace u_net
{
    partial class F_TransferList_Others
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            groupBox.Controls.Add(支払金額);
            groupBox.Controls.Add(備考_ラベル);
            groupBox.Controls.Add(支払金額_ラベル);
            groupBox.Controls.Add(種類コード);
            groupBox.Controls.Add(支払種類_ラベル);
            groupBox.Controls.Add(削除ボタン);
            groupBox.Controls.Add(支払明細_ラベル);
            ...
            備考.Location = new Point(201, 393);
            備考.Margin = new Padding(3, 2, 3, 2);
            備考.Name = "備考";
            備考.Size = new Size(253, 20);
            備考.TabIndex = 16;
            // 
            // 支払金額
            // 
            支払金額.BackColor = Color.White;
            支払金額.Font = new Font("BIZ UDゴシック", 9.75F, FontStyle.Regular, GraphicsUnit.Point);
            支払金額.ImeMode = ImeMode.Disable;
            支払金額.Location = new Point(97, 393);
            支払金額.Margin = new Padding(3, 2, 3, 2);
            支払金額.Name = "支払金額";
            支払金額.Size = new Size(102, 20);
            支払金額.TabIndex = 14;
            // 
            // 備考_ラベル
            // 
            ...
            備考_ラベル.Location = new Point(209, 372);
            ...
            // 支払金額_ラベル
            // 
            支払金額_ラベル.AllowDrop = true;
            支払金額_ラベル.AutoEllipsis = true;
            支払金額_ラベル.Font = new Font("BIZ UDゴシック", 9F, FontStyle.Regular, GraphicsUnit.Point);
            支払金額_ラベル.ForeColor = SystemColors.ActiveCaptionText;
            支払金額_ラベル.ImageAlign = ContentAlignment.MiddleLeft;
            支払金額_ラベル.Location = new Point(101, 372);
            支払金額_ラベル.Margin = new Padding(0);
            支払金額_ラベル.Name = "支払金額_ラベル";
            支払金額_ラベル.Size = new Size(102, 20);
            支払金額_ラベル.TabIndex = 13;
            支払金額_ラベル.Text = "支払金額(&A)";
            支払金額_ラベル.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // 種類コード
            // 
            種類コード.BackColor = Color.White;
            種類コード.Font = new Font("BIZ UDゴシック", 9.75F, FontStyle.Regular, GraphicsUnit.Point);
            種類コード.FormattingEnabled = true;
            種類コード.ImeMode = ImeMode.Disable;
            種類コード.Location = new Point(13, 393);
            種類コード.Name = "種類コード";
            種類コード.Size = new Size(82, 21);
            種類コード.TabIndex = 12;
            // 
            // 支払種類_ラベル
            // 
            支払種類_ラベル.AllowDrop = true;
            支払種類_ラベル.AutoEllipsis = true;
            支払種類_ラベル.Font = new Font("BIZ UDゴシック", 9F, FontStyle.Regular, GraphicsUnit.Point);
            支払種類_ラベル.ForeColor = SystemColors.ActiveCaptionText;
            支払種類_ラベル.ImageAlign = ContentAlignment.MiddleLeft;
            支払種類_ラベル.Location = new Point(13, 372);
            支払種類_ラベル.Margin = new Padding(0);
            支払種類_ラベル.Name = "支払種類_ラベル";
            支払種類_ラベル.Size = new Size(82, 20);
            支払種類_ラベル.TabIndex = 11;
            支払種類_ラベル.Text = "支払種類(&K)";
            支払種類_ラベル.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // 削除ボタン
            // 
            削除ボタン.Location = new Point(121, 341);
            削除ボタン.Name = "削除ボタン";
            ...
            // 支払明細_ラベル
            // 
            支払明細_ラベル.AllowDrop = true;
            支払明細_ラベル.AutoEllipsis = true;
            支払明細_ラベル.Font = new Font("BIZ UDゴシック", 9F, FontStyle.Regular, GraphicsUnit.Point);
            支払明細_ラベル.ForeColor = SystemColors.ActiveCaptionText;
            支払明細_ラベル.ImageAlign = ContentAlignment.MiddleLeft;
            支払明細_ラベル.Location = new Point(13, 100);
            支払明細_ラベル.Margin = new Padding(0);
            支払明細_ラベル.Name = "支払明細_ラベル";
            支払明細_ラベル.Size = new Size(95, 20);
            支払明細_ラベル.TabIndex = 7;
            支払明細_ラベル.Text = "支払明細(&L)";
            支払明細_ラベル.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // 支払先参照ボタン
            // 
            ...
            // 追加ボタン
            // 
            追加ボタン.Location = new Point(13, 341);
            追加ボタン.Name = "追加ボタン";
