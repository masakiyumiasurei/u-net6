...
namespace u_net
{
    partial class F_製品参照
    {
        ...
        private void InitializeComponent()
        {
            ...
            廃止 = new CheckBox();
            廃止_ラベル = new Label();
            製品明細参照1 = new MultiRowDesigner.製品明細参照();
            承認表示 = new TextBox();
            確定表示 = new TextBox();
            ...
            // コマンド全印刷
            // 
            コマンド全印刷.Font = new Font("BIZ UDPゴシック", 9F, FontStyle.Regular, GraphicsUnit.Point);
            コマンド全印刷.ForeColor = Color.Blue;
            コマンド全印刷.ImageAlign = ContentAlignment.BottomLeft;
            コマンド全印刷.Location = new Point(440, 5);
            コマンド全印刷.Margin = new Padding(3, 2, 3, 2);
            コマンド全印刷.Name = "コマンド全印刷";
            コマンド全印刷.Size = new Size(70, 20);
            コマンド全印刷.TabIndex = 1010;
            コマンド全印刷.TabStop = false;
            コマンド全印刷.Text = "全印刷";
            toolTip1.SetToolTip(コマンド全印刷, "ユニット表・部品表の印刷");
            コマンド全印刷.UseVisualStyleBackColor = true;
            コマンド全印刷.Click += コマンド全印刷_Click;
            // 
            // コマンドユニット表
            // 
            ...
            シリーズ名.Location = new Point(107, 95);
            ...
            確定者コード.TextChanged += 確定日時_TextChanged;
            // 
            // 承認者名
            // 
            ...
            承認者コード.TextChanged += 承認日時_TextChanged;
            // 
            // 無効日時
            // 
            ...
            無効日時.Location = new Point(419, 123);
            ...
            指導書変更.Enabled = false;
            指導書変更.Font = new Font("BIZ UDゴシック", 9F, FontStyle.Regular, GraphicsUnit.Point);
            ...
            label13.Location = new Point(180, 120);
            label13.Margin = new Padding(0);
            label13.Name = "label13";
            label13.Size = new Size(49, 20);
            label13.TabIndex = 10197;
            label13.Text = "-04**";
            ...
            廃止_ラベル.Location = new Point(9, 244);
            廃止_ラベル.Margin = new Padding(0);
            廃止_ラベル.Name = "廃止_ラベル";
            廃止_ラベル.Size = new Size(95, 21);
            廃止_ラベル.TabIndex = 16;
            廃止_ラベル.Text = "廃止(&A)";
            // 
            // 製品明細参照1
