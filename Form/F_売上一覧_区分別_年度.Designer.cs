namespace u_net
{
    partial class F_売上一覧_区分別_年度
    {
        ...
        private void InitializeComponent()
        {
            ...
            panel2.Name = "panel2";
            panel2.Size = new Size(1054, 174);
            panel2.TabIndex = 88;
            // 
            // label2
            // 
            label2.AutoSize = true;
            label2.Location = new Point(252, 4);
            label2.Name = "label2";
            ...
            dataGridView2.Location = new Point(289, 8);
            dataGridView2.Margin = new Padding(3, 2, 3, 2);
            dataGridView2.Name = "dataGridView2";
            dataGridView2.ReadOnly = true;
            dataGridView2.RowTemplate.Height = 29;
            dataGridView2.Size = new Size(762, 160);
            dataGridView2.TabIndex = 89;
            // 
            // 表示件数
            // 
            表示件数.Location = new Point(71, 2);
            ...
            年度.FormattingEnabled = true;
            年度.ImeMode = ImeMode.Disable;
            年度.Location = new Point(96, 6);
            年度.Name = "年度";
            年度.Size = new Size(114, 21);
            年度.TabIndex = 2;
            年度.SelectedIndexChanged += 年度_SelectedIndexChanged;
            // 
            // メーカーコード_ラベル
            // 
            ...
            Text = "売上一覧（売上区分別）";
            FormClosing += F_売上一覧_区分別_年度_FormClosing;
            Load += Form_Load;
        ...
        //private newDataSetTableAdapters.V売上一覧_区分別_年度TableAdapter v売上一覧_区分別_年度TableAdapter;
        ...
        //private newDataSetTableAdapters.Q売上一覧_区分別_年度TableAdapter q売上一覧_区分別_年度TableAdapter;
