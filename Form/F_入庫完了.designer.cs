...
namespace u_net
{
    partial class F_入庫完了
    {
        ...
        private void InitializeComponent()
        {
            ...
            statusStrip1.Size = new Size(447, 22);
            ...
            注釈2_ラベル.Location = new Point(95, 222);
            注釈2_ラベル.Margin = new Padding(0);
            注釈2_ラベル.Name = "注釈2_ラベル";
            注釈2_ラベル.Size = new Size(314, 32);
            注釈2_ラベル.TabIndex = 3;
            注釈2_ラベル.Text = "※対象となる全入庫データを確定した場合、\r\n　この画面で確定を解除することはできません。";
            ...
            支払年月_ラベル.Location = new Point(10, 60);
            支払年月_ラベル.Margin = new Padding(0);
            支払年月_ラベル.Name = "支払年月_ラベル";
            支払年月_ラベル.Size = new Size(82, 20);
            支払年月_ラベル.TabIndex = 1;
            支払年月_ラベル.Text = "完了入庫(&S)";
