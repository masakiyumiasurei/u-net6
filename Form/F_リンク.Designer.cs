namespace u_net
{
    partial class F_リンク
    {
        ...
        private void InitializeComponent()
        {
            ...
            品名_ラベル.Location = new Point(7, 3);
            品名_ラベル.Margin = new Padding(0);
            品名_ラベル.Name = "品名_ラベル";
            品名_ラベル.Size = new Size(702, 25);
            品名_ラベル.TabIndex = 1;
            品名_ラベル.Text = "グループ名：";
            ...
            // 開くボタン
            // 
            開くボタン.Location = new Point(469, 472);
            開くボタン.Margin = new Padding(3, 4, 3, 4);
            開くボタン.Name = "開くボタン";
            開くボタン.Size = new Size(117, 32);
            開くボタン.TabIndex = 2;
            開くボタン.Text = "開く(&O)";
            ...
            // 閉じるボタン
            // 
            閉じるボタン.Location = new Point(592, 472);
            ...
            グループ名.Location = new Point(7, 31);
            グループ名.Name = "グループ名";
            グループ名.ReadOnly = true;
            グループ名.Size = new Size(701, 20);
            グループ名.TabIndex = 19;
            グループ名.TabStop = false;
            // 
            // label1
            ...
            行番号.Location = new Point(7, 88);
            行番号.Name = "行番号";
            行番号.ReadOnly = true;
            行番号.Size = new Size(27, 20);
            行番号.TabIndex = 21;
            行番号.TabStop = false;
            行番号.Visible = false;
            // 
            ...
            コード.Location = new Point(33, 88);
            コード.Name = "コード";
            コード.ReadOnly = true;
            コード.Size = new Size(100, 20);
            コード.TabIndex = 22;
            コード.TabStop = false;
            // 
            // 文書名
            ...
            件名.Location = new Point(326, 88);
            件名.Name = "件名";
            件名.ReadOnly = true;
            件名.Size = new Size(382, 20);
            件名.TabIndex = 24;
            件名.TabStop = false;
            // 
            // label2
            ...
            // リンク解除ボタン
            // 
            リンク解除ボタン.Location = new Point(7, 472);
            リンク解除ボタン.Margin = new Padding(3, 4, 3, 4);
            リンク解除ボタン.Name = "リンク解除ボタン";
            リンク解除ボタン.Size = new Size(117, 32);
            リンク解除ボタン.TabIndex = 1;
            ...
            dataGridView1.Location = new Point(7, 147);
            dataGridView1.Margin = new Padding(3, 4, 3, 4);
            dataGridView1.MultiSelect = false;
            dataGridView1.Name = "dataGridView1";
            dataGridView1.RowTemplate.Height = 25;
            dataGridView1.Size = new Size(702, 317);
