...
{          
    ...
    partial class 購買発注先テンプレート
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(購買発注先テンプレート));
            ...
            this.チェック = new GrapeCity.Win.MultiRow.CheckBoxCell();
            this.発注書プレビューボタン = new GrapeCity.Win.MultiRow.ButtonCell();
            this.発注コード = new GrapeCity.Win.MultiRow.TextBoxCell();
            this.発注日 = new GrapeCity.Win.MultiRow.TextBoxCell();
            this.仕入先名 = new GrapeCity.Win.MultiRow.TextBoxCell();
            this.電話番号 = new GrapeCity.Win.MultiRow.TextBoxCell();
            ...
            this.Row.Cells.Add(this.チェック);
            this.Row.Cells.Add(this.発注書プレビューボタン);
            this.Row.Cells.Add(this.発注コード);
            this.Row.Cells.Add(this.発注日);
            this.Row.Cells.Add(this.仕入先名);
            this.Row.Cells.Add(this.電話番号);
            this.Row.Cells.Add(this.ファックス番号);
            this.Row.Cells.Add(this.担当者名);
            this.Row.Cells.Add(this.発注者コード);
            ...
            this.コマンドボタン.Style = cellStyle12;
            ...
            this.置換不可指定ボタン.Style = cellStyle13;
            ...
            cellStyle14.Image = ((System.Drawing.Image)(resources.GetObject("cellStyle14.Image")));
            ...
            this.buttonCell1.Style = cellStyle14;
            ...
            this.発注コードボタン.Style = cellStyle15;
            ...
            this.仕入先名ボタン.Style = cellStyle17;
            ...
            this.電話番号ボタン.Style = cellStyle18;
            ...
            this.ファックス番号ボタン.Style = cellStyle19;
            ...
            this.担当者名ボタン.Style = cellStyle20;
            ...
            this.発注者名ボタン.Style = cellStyle21;
            ...
            cellStyle23.Border = border10;
            cellStyle23.Font = new System.Drawing.Font("BIZ UDPゴシック", 9F);
            this.発注者名設定_ラベル.Style = cellStyle23;
            this.発注者名設定_ラベル.TabIndex = 11;
            this.発注者名設定_ラベル.Value = "発注者名設定";
            // 
            // 発注者コード統一
            // 
            this.発注者コード統一.DisplayMember = "変更操作";
            this.発注者コード統一.DropDownWidth = 102;
            ...
            this.明細番号.Size = new System.Drawing.Size(34, 22);
            ...
            // チェック
            // 
            this.チェック.CheckAlign = System.Drawing.ContentAlignment.MiddleCenter;
            this.チェック.DataField = "チェック";
            this.チェック.Location = new System.Drawing.Point(34, 0);
            this.チェック.Name = "チェック";
            ...
            // 発注書プレビューボタン
            // 
            this.発注書プレビューボタン.Enabled = false;
            this.発注書プレビューボタン.Location = new System.Drawing.Point(56, 0);
            ...
            this.発注書プレビューボタン.Style = cellStyle3;
            this.発注書プレビューボタン.TabIndex = 2;
            this.発注書プレビューボタン.TabStop = false;
            // 
            // 発注コード
            // 
            this.発注コード.DataField = "発注コード";
            this.発注コード.Location = new System.Drawing.Point(78, 0);
            this.発注コード.Name = "発注コード";
            this.発注コード.Size = new System.Drawing.Size(82, 22);
            ...
            this.発注コード.TabStop = false;
            // 
            // 発注日
            // 
            this.発注日.DataField = "発注日";
            this.発注日.Location = new System.Drawing.Point(160, 0);
            this.発注日.Name = "発注日";
            ...
            this.発注日.TabIndex = 4;
            this.発注日.TabStop = false;
            // 
            // 仕入先名
            // 
            this.仕入先名.DataField = "仕入先名";
            this.仕入先名.Location = new System.Drawing.Point(242, 0);
            this.仕入先名.Name = "仕入先名";
            ...
            // 電話番号
            // 
            this.電話番号.DataField = "電話番号";
            this.電話番号.Location = new System.Drawing.Point(470, 0);
            this.電話番号.Name = "電話番号";
            ...
            this.電話番号.TabStop = false;
            // 
            // ファックス番号
            // 
            this.ファックス番号.DataField = "ファックス番号";
            this.ファックス番号.Location = new System.Drawing.Point(562, 0);
            this.ファックス番号.Name = "ファックス番号";
            ...
            this.ファックス番号.TabStop = false;
            // 
            // 担当者名
            // 
            this.担当者名.DataField = "担当者名";
            this.担当者名.Location = new System.Drawing.Point(654, 0);
            this.担当者名.Name = "担当者名";
            ...
            // 発注者コード
            // 
            this.発注者コード.DisplayMember = "変更操作";
            this.発注者コード.DropDownWidth = 102;
            ...
            this.購買コード.Location = new System.Drawing.Point(734, 0);
            this.購買コード.Name = "購買コード";
            this.購買コード.ReadOnly = true;
            this.購買コード.Size = new System.Drawing.Size(10, 22);
            ...
            this.購買コード.Style = cellStyle11;
            this.購買コード.TabIndex = 10;
        ...
        private GrapeCity.Win.MultiRow.CheckBoxCell チェック;
        private GrapeCity.Win.MultiRow.ButtonCell 発注書プレビューボタン;
        private GrapeCity.Win.MultiRow.TextBoxCell 発注コード;
        private GrapeCity.Win.MultiRow.TextBoxCell 発注日;
        private GrapeCity.Win.MultiRow.TextBoxCell 仕入先名;
        private GrapeCity.Win.MultiRow.TextBoxCell 電話番号;
