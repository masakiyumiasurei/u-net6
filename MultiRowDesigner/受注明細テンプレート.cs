...
namespace MultiRowDesigner
{
    public sealed partial class 受注明細テンプレート : Template
    {
        ...
        public 受注明細テンプレート()
        {
            ...
            ofn.SetComboBox(ラインコード, "SELECT Code AS Value, Name AS Display, Note FROM ManufactureFlow ORDER BY Number");
            ...
            this.test.DataSource = new KeyValuePair<String, String>[] {
                new KeyValuePair<String, String>("01", "付属する"),
                new KeyValuePair<String, String>("02", "付属しない"),
            };
            this.ParameterSheet.DisplayMember = "Value";
